...
class Qrisk extends CI_Controller {
	...
	public function index(){
		...
		$ethrisk=0; 
		$fh_cvd=0; 
		$rati=7.0;   // 1.0 - 11.0  // Cholesterol/HDL ratio
		$sbp=130;   // 70-240   //Systolic blood pressure (mmHg):
		$sbps5=20.0; // 0-40     // Standard deviation of at least two most recent systolic blood pressure readings (mmHg):
...
//function cvd_female_raw(int age,int b_AF,int b_atypicalantipsy,int b_corticosteroids,int b_migraine,int b_ra,int b_renal,int b_semi,int b_sle,int b_treatedhyp,int b_type1,int b_type2,double bmi,int ethrisk,int fh_cvd,double rati,double sbp,double sbps5,int smoke_cat,int surv,double town)
...

{
   ...
   //echo $Ismoke[$smoke_cat]; exit; //$Iethrisk[$ethrisk]; exit;
...
//function cvd_male_raw(int age,int b_AF,int b_atypicalantipsy,int b_corticosteroids,int b_impotence2,int b_migraine,int b_ra,int b_renal,int b_semi,int b_sle,int b_treatedhyp,int b_type1,int b_type2,double bmi,int ethrisk,int fh_cvd,double rati,double sbp,double sbps5,int smoke_cat,int surv,double town)
function cvd_male_raw($age, $b_AF, $b_atypicalantipsy, $b_corticosteroids, $b_impotence2, $b_migraine, $b_ra, $b_renal, $b_semi, $b_sle, $b_treatedhyp, $b_type1, $b_type2,  $bmi, $ethrisk, $fh_cvd, $rati, $sbp, $sbps5, $smoke_cat, $surv, $town)
{
	$survivor = [
		0,
		0,
