...
class Orders extends CI_Controller {
	...
	public function list_data() {
		...
		if(empty($this->input->post('search')['value'])) {
			...
			$sq=$this->db->query('select orders.*,users.userFirstName,users.userLastName from orders 
			LEFT JOIN users ON orders.userId=users.userId'.
			...
			$whr.=' and (orderId like "%'.$search.'%" or  userFirstName like "%'.$search.'%"  or orderAmount like "%'.$search.'%" or  orderShipAddress like "%'.$search.'%")';
