										...
										<div class="shopping-cart">
											...
											if($cart_data_new){
												...
												<div class="item" id="row_<?=$key?>">
                                                    ...
                                                    <?php foreach($item['scheduleDate'] as $sd){ ?>
                                                    
                                                    <?php echo date('M d, Y',strtotime($sd)); ?> <br />
			...
			$.confirm({
				...
				buttons: {
					Yes: {
						...
						btnClass: 'btn-green',
						action: function(){
							top.location.href='<?=base_url("memberships")?>';
						}
					},
					No: {
					   	text: 'No',
						...
						$.confirm({
							...
							content: function () {
								...
								return $.ajax({
									...
									//	$('#payNow_span').html(response.payNow);
									//	$('#PayLater_span').html(response.PayLater);
