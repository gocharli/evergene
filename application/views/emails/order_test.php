                          ...
                          <table class="p100" style="margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0; width: 600px;" width="600" cellspacing="0" cellpadding="0" border="0" align="center">
                            ...
                            <tr>
                              <td align="center" valign="top">
                                <table class="p100" style="margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0;" cellspacing="0" cellpadding="0" border="0">
                                  <tr>
                                    <td class="center" style="color: #000; font-size: 14px; line-height: 21px; word-break: break-all; word-wrap: break-word; mso-line-height-rule: exactly;" align="center" valign="top"><font face="'Open Sans', sans-serif">Your order has been placed successfully.Please click on the button to view the order.</font>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                                                ...
                                                <td align="center" valign="top">
                                                  ...
                                                  cellspacing="0" cellpadding="0" border="0" bgcolor="#d30000">
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td align="center" valign="top"><a href="<?php echo $link; ?>" _target="blank" style="border: none; color: #fff; display: block; font-family: 'Open Sans', sans-serif; font-size: 14px; font-weight: 600; outline: none; padding: 0; text-decoration: none;">View Order</a>
                                                      </td>
                                                      <td style="width: 50px;" width="50" valign="top" align="left">&nbsp;</td>
                                                    </tr>
                                                    <tr>
