...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #D8D8D8; margin: 0; padding: 0; width: 100%;">
    ...
    <tr>
      <td align="center" valign="top">
        <table class="p100" style="margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0; width: 800px;" width="800" cellspacing="0" cellpadding="0" border="0">
            ...
            <td style="" align="center" valign="top" bgcolor="#FFF" >
              &nbsp;
            </td>
          </tr>
          <tr>
  ...
  <table style="background-color: #D8D8D8; margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0; width: 100%;" cellspacing="0" cellpadding="0" border="0" bgcolor="#D8D8D8" width="100%">
    <tr>
      <td align="center" valign="top">
        <table class="p100" style="margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0; width: 800px;" width="800" cellspacing="0" cellpadding="0" border="0">
          <tr>
            <td style="background-color: #f9f9f9; background-position: center center; background-size: cover;" align="center" valign="top" bgcolor="#1F2229" >
                      ...
                      <tr>
                        <td valign="top" align="left">
                          <table class="p100" style="margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0; width: 600px;" width="600" cellspacing="0" cellpadding="0" border="0" align="center">
                            ...
                            <tr>
                              <td align="center" valign="top">
                                <table class="p100" style="margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0;" cellspacing="0" cellpadding="0" border="0">
                                  <tr>
                                    <td class="center" style="color: #000; font-size: 25px; font-weight: bold; line-height: 39px; mso-line-height-rule: exactly;" align="center" valign="top"><font face="'Open Sans', sans-serif">Dear <?php echo $title; ?>!</font>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                            ...
                            <tr>
                              <td style="height: 35px; line-height: 35px; mso-line-height-rule: exactly;" valign="top" align="left">&nbsp;</td>
                            </tr>
                            <tr>
                              <td align="center" valign="top">
                                <table class="p100" style="margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0;" cellspacing="0" cellpadding="0" border="0">
                                  <tr>
                                    <td class="center" style="color: #000; font-size: 15px; line-height: 21px; word-break: break-all; word-wrap: break-word; mso-line-height-rule: exactly;" align="center" valign="top"><font face="'Open Sans', sans-serif">Your can order <?php echo $available_orders; ?> items this month. Click on the button to buy more tests at discounted price.</font>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                                  ...
                                  <tr>
                                    <td align="center" valign="top">
                                      <!--[if gte mso 9]>
                                           ...
                                           <td align="center" valign="top">
                                          <![endif]-->
                                      <table class="p100" style="margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0;" cellspacing="0" cellpadding="0" border="0" align="left">
                                        <tr>
                                          <td align="center" valign="top">
                                            <table style="margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0; width: 100%;" cellspacing="0" cellpadding="0" border="0" width="100%">
                                              <tr>
                                                <td align="center" valign="top">
                                                  <table style="-moz-border-radius: 30px; -webkit-border-radius: 30px; background-color: #86c44c; border: 1px solid #86c44c; border-collapse: initial; border-radius: 30px; color: #fff; font-family: 'Open Sans', sans-serif; font-size: 14px; margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; overflow: hidden; padding: 0;"
                                                  cellspacing="0" cellpadding="0" border="0" bgcolor="#d30000">
                                                    <tr>
                                                      <td colspan="3" style="height: 10px; line-height: 8px; mso-line-height-rule: exactly;" valign="top" align="left">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                      <td style="width: 50px;" width="50" valign="top" align="left">&nbsp;</td>
                                                      <td align="center" valign="top"><a href="<?php echo $link; ?>" _target="blank" style="border: none; color: #fff; display: block; font-family: 'Open Sans', sans-serif; font-size: 14px; font-weight: 600; outline: none; padding: 0; text-decoration: none;">Buy</a>
                                                      </td>
                                                      <td style="width: 50px;" width="50" valign="top" align="left">&nbsp;</td>
                                                    </tr>
                                                    <tr>
  ...
  <table style="background-color: #D8D8D8; margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0; width: 100%;" cellspacing="0" cellpadding="0" border="0" bgcolor="#D8D8D8" width="100%">
    <tr>
      <td align="center" valign="top">
        <table class="p100" style="background-color: #fff; margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0; width: 800px;" width="800" cellspacing="0" cellpadding="0" border="0" bgcolor="#fff">
          <tr>
            <td align="center" valign="top">
                ...
                <tr>
                  ...
                  <td align="center" valign="top">
                    ...
                    <table style="margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0;" cellspacing="0" cellpadding="0" border="0" align="center">
                      ...
                      <tr>
                        <td style="color: #000; font-size: 12px; font-weight: normal; letter-spacing: 0.02em; text-align: center;" valign="top" align="left"><font face="'Open Sans', sans-serif">Copyright 2020 EverGene. All rights reserved</font>
                        </td>
                      </tr>
                      
                      <tr>
                        <td style="color: #807f82; font-family: 'Open Sans', sans-serif; font-size: 13px; font-weight: normal; letter-spacing: 0.02em; line-height: 23px; text-align: center; text-decoration: underline; mso-line-height-rule: exactly;" valign="top" align="left">
                          <a href="#" class="text3" style="border: none; color: #807f82; display: block; font-family: 'Open Sans', sans-serif; font-size: 13px; font-weight: normal; letter-spacing: 0.02em; line-height: 23px; outline: none; text-align: center; text-decoration: underline;"><font face="'Open Sans', sans-serif">Unsubscribe here</font>
                          </a>
                        </td>
                      </tr>
                      <tr>
