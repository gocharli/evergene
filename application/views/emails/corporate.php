                          ...
                          <table class="p100" style="margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0; width: 600px;" width="600" cellspacing="0" cellpadding="0" border="0" align="center">
                            ...
                            <tr>
                              <td align="center" valign="top">
                                <table class="p100" style="margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0;" cellspacing="0" cellpadding="0" border="0">
                                  <tr>
                                    <td class="center" style="color: #000; font-size: 25px; font-weight: bold; line-height: 39px; mso-line-height-rule: exactly;" align="center" valign="top"><font face="'Open Sans', sans-serif">Dear Admin!</font>
                                    </td>
                                  </tr>
                                </table>
                              </td>
                            ...
                            <tr>
                              <td align="center" valign="top">
                                <table class="p100" style="margin: 0; mso-table-lspace: 0; mso-table-rspace: 0; padding: 0;" cellspacing="0" cellpadding="0" border="0">
                                  <tr>
                                    <td class="center" style="color: #000; font-size: 15px; line-height: 21px; word-break: break-all; word-wrap: break-word; mso-line-height-rule: exactly;" align="center" valign="top"><font face="'Open Sans', sans-serif"> <?php echo $message; ?> </font>
                                    </td>
                                  </tr>
                                </table>
                              </td>
