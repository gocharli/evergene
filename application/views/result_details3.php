												...
												?>
													<div class="col-md-12 col-xs-12 row mix technical investment m-0 p-0">
														<div>
															...
															<h5 class="marker-heading"><?php //echo $m_title; 
																						?></h5>
															<div class="single-service" style="margin-bottom: 30px;border: 1px solid rgba(0,0,0,0.07);padding: 20px;border-radius: 5px;background: #FFF;">
																...
																<div class="row">
																	<div class="result-value <?php if ($res->result3 == 'Positive') echo 'positive';
																								else echo 'res_div'; ?> p-0">
																		<div style="">
			...
			<script type="text/javascript">
				...
				function call_request(type = 'nurse') {
					$.ajax({
						...
						data: {
							'type': type,
							'orderId': <?= $order_details->detailId ?>
						},
						method: 'post'
