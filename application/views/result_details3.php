						...
						<div class="row">
							<div class="col-lg-12 col-xs-12">
								...
								<div class="single-product shop-sidebar result-type">
									...
									<div class="product-header m-0">
										<h6 class="print-design"><img  src="<?=base_url(); ?>uploads/tests/logo/<?php echo $order_details->testLogo; ?>" alt="" style="width:10%"/>
										  <span style="margin-left:1rem;padding:1% 0%"> <?=$order_details->testName?> <small>(Date : <?=date('d F Y',strtotime($order_details->resultReceivedDate))?>)</small></span> 
										</h6>
										
										<div class="row">
										    <br><br>
											<div class="col-lg-12">
												<table class="table table-borderless table-sm m-0 result-table">
												  	<thead>
												  	    <tr>
												    		<td scope="col">
                                    ...
                                    <div style="margin-top:20px">
										...
										<p class="mb-15"> <?php echo $results[0]->testDescription; ?></p>
												...
												<?php $p=0; /*  $p is for merkers title if empty   */ foreach ($results as $res){ //echo '<pre>'; print_r($res); 
													...
													?>
													 <div class="col-md-12 col-xs-12 row mix technical investment m-0 p-0">
													<div>
												<h5 class="marker-heading mb-15"><?php echo $m_title; ?></h5>
													<h5 class="marker-heading"><?php //echo $m_title; ?></h5>
														...
														<p> <?php echo $res->topText; ?></p><br>
												     	<div class="row">
                                                        <div class="result-value <?php if($res->result3 == 'Positive') echo 'positive'; else echo 'res_div'; ?> p-0">
                                                            <div style="" >
															<?php if($res->result3 == 'Positive'){ ?>
                                                                <span class="pos-result">	<i class="fa fa-exclamation-circle" id="info-icon" aria-hidden="true" style="color:red"></i> <?php echo $res->result3; ?> </span>
															<?php }else{ ?>
																<span class="neg-result">	<i class="fa fa-exclamation-circle" id="info-icon" aria-hidden="true" style="color:green"></i> <?php echo $res->result3; ?> </span>
															<?php } ?>
															</div>
														...
														<!-- <?php if($res->result3 == 'Positive'){ ?>
															<div style="float:left; margin-left:2rem" >
                                                                <span class="pos-result">	<i class="fa fa-exclamation-circle" id="info-icon" aria-hidden="true" style="color:red"></i> Positive</span>
															</div>
														 <?php }else{ ?>
															<div  style="float:left; margin-left:2rem">
														<span class="neg-result" >	<i class="fa fa-exclamation-circle" id="info-icon" aria-hidden="true" style="color:green"></i> Negative</span>
															</div>
														<?php } ?> -->
                                                    </div>
														<!-- <?php if($res->result3 == 'Positive'){ ?>
															<div class="positive" ><?php echo $res->testName; ?> Result : <i class="fa fa-exclamation-circle" id="info-icon" aria-hidden="true" style="color:red"></i> Positive </div>
														<?php }else{ ?>
															<div class="res_div " ><?php echo $res->testName; ?> Result : <i class="fa fa-check-circle" id="info-icon" aria-hidden="true" style="color:green"></i> Negative  </div>
														<?php } ?> -->
                                                        <br>
									...
									<div class="charlestestpdfdiv"></div>
								</div> <!-- /.single-product -->
    ...
    <?php if($order_details->resultHistory=='Yes'){ ?>
      ...
      <?php } ?>  
		...
		function generate()
		{
			...
			//$(".charlestestpdfdiv").html(divToPrint);

			newWin.document.open();

			newWin.document.write("<html><head><link rel='stylesheet' href='https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css' ><link rel='stylesheet' type='text/css' href='<?=base_url('assets/front/')?>css/style.css'><style type='text/css'>.ruler_active {background: #86c44c !important;height: 34px !important;border-left: 0px !important;width: 11% !important; -webkit-print-color-adjust: exact; } #html-2-pdfwrapper table td{font-weight:400 !important;} #html-2-pdfwrapper .product-header img{ width:50px !important; height:50px !important;} </style></head><body onload='window.print()'><h2 style='text-align:center'>Results <?=$order_details->testName?></h2>"+divToPrint.innerHTML+"</body></html>");
