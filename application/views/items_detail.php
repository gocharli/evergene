		...
		<div class="container">
								...
								<?php if($imoreImages) {
									...
									foreach ($imoreImages as $image) { ?>
										<div class="item text-center <?php if($i==0){?>active<?php } ?>">
											<img  style="height:400px; " src="<?=base_url('uploads/tests/products/'.$image->imageName)?>" alt="...">
										</div>
										<?php $i++; }
								}?>
						...
						<div class="product-info">
							...
							<fieldset>
								<div class="field-radio">
									...
									<div class="box-radio-option">
										<label for="purchase-subscribe"> Setup a regular Item &nbsp;  <a href="javascript:;">Learn More</a></label>
									</div>
								</div>
								<div class="field-radio">
			...
			<div class="product-review-tab">
				<ul class="nav nav-tabs">
                    ...
                    <?php } if($row->testSymtoms!=''){ ?>
					<li><a data-toggle="tab" href="#menu21">Symtoms</a></li>
					<?php } if($faqs){ ?>
				...
				<div class="tab-content ckeditr">
					...
					<div id="menu12" class="tab-pane fade" style="margin-top: 10px;">
						<p><?php
							if($row->testMarkers!='')
							{
							...
							<?php  foreach ($related as $ritem){ ?>
								<div class="item">
									<div class="single-service">
										...
										<a href="<?=base_url('items/'.$ritem->slug)?>" class="custom-btn">Learn More</a>
									</div> <!-- /.single-product -->
								</div> <!-- /.col- -->
