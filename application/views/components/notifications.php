<?php
 ...
 { 
    ...
    ?>
     <li >
        <div class="card list-view-media <?php if($row->notificationStatus==1){ echo 'bg-warning'; } ?>" id="nt_<?=$row->notificationID?>" onclick="notifications_detail(<?=$row->notificationID?>)">
