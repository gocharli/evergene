...
<div class="main-page-wrapper">
														...
														<div class="single-service m-bottom0">
																...
																<div class="row">
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<input type="text" class="form-control" name="f_name" value="<?=$row->f_name?>" onKeyPress="return ValidateAlpha(event);" />
																	</div>
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		<label>Second Name*</label>
																		<input type="text" class="form-control" name="l_name" value="<?=$row->l_name?>"onKeyPress="return ValidateAlpha(event);" />
																	</div>
																</div>
															</div>
															...
															<div class="form-group">
																...
																<div class="row">
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			<div class="md-radio md-radio-inline">
																				<input class="alergies rc" <?php if($row->gender=='Male' || $row->gender=='') { echo 'checked=""'; } ?> id="male" value="Male" type="radio" name="gender" >
																				<label for="male">Male</label>
																			</div>
																			<div class="md-radio md-radio-inline">
																				<input class="alergies rc" <?php if($row->gender=='Female') { echo 'checked=""'; } ?>
																					   id="female" value="Female" type="radio" name="gender" >
																	...
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<input type="text" class="form-control date" name="dob" value="<?php if($row->dob!='0000-00-00'){ echo $row->dob; }?>" />
																	</div>
																	<div class="clearfix"></div>
																</div>
															...
															<div class="form-group">
																<div class="row">
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<input type="text" class="form-control number" name="height" value="<?=$row->height?>" />
																	</div>
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		<label>Weight (KG)</label>
																		<input type="text" class="form-control number" name="weight" value="<?=$row->weight?>" />
																	</div>
																...
																<div class="row">
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<input type="text" class="form-control number" name="hipMeasurment" value="<?=$row->hipMeasurment?>" />
																	</div>
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		<label>Waist measurement (cm)</label>
																		<input type="text" class="form-control number" name="waistMeasurment" value="<?=$row->waistMeasurment?>" />
																	</div>
																	<div class="clearfix"></div>
																</div>
															</div>
																...
																<div class="row">
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<select name="excericseAvgWeek" class="form-control">
																			<option value="<?=$row->excericseAvgWeek?>" selected disabled><?=$row->excericseAvgWeek?></option>
																	...
																	<select name="stepAvgDay" class="form-control">
																			...
																			<option value="2999-3000 ">2999, 3000 </option>
																			<option value="5999-6000 ">5999, 6000 </option>
																			<option value="9999-10000 ">9999, 10000 </option>
																			<option value="12000-12000">12000, 12,000+</option>
																...
																<div class="row">
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="trackHeart rc" <?php if($row->trackExercise=='No' || $row->trackExercise=='') { echo 'checked=""'; } ?> id="exercise_No" value="No" type="radio" name="exercise" >
																	...
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="trackHeart rc" <?php if($row->stepTrack=='No' || $row->stepTrack=='') { echo 'checked=""'; } ?> id="steps_No" value="No" type="radio" name="step" >
																...
																<div class="row">
																	...
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<select  name="sleepPerNight" class="form-control bodyType">
																			...
																			<option value="2">Less then 3</option>
																...
																<div class="row">
																	...
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="sleepTrack" id="sleepTrack_No" <?php if($row->sleepTrack=='No' || $row->sleepTrack=='') { echo 'checked=""'; } ?> value="No" type="radio" name="sleepTrack" >
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="sleepTrack" id="smoke_No" <?php if($row->trackSmoking=='No' || $row->trackSmoking=='') { echo 'checked=""'; } ?> value="No" type="radio" name="smokeTrack" >
																...
																<div class="row">
																	...
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="sleepTrack" id="water_No" <?php if($row->trackWater=='No' || $row->trackWater=='') { echo 'checked=""'; } ?> value="No" type="radio" name="waterTrack" >
																	...
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="sleepTrack" id="alcohol_No" <?php if($row->trackAlcohol=='No' || $row->trackAlcohol=='') { echo 'checked=""'; } ?> value="No" type="radio" name="alcoholTrack" >
																...
																<div class="row">
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="alergies rc" <?php if($row->alergies=='No' || $row->alergies=='') { echo 'checked=""'; } ?>
													...
													<input type="checkbox" value="other" name="alerg[]"> other
																	...
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="intolerances rc" <?php if($row->intolerances=='No' || $row->intolerances=='') { echo 'checked=""'; } ?> id="intolerances_No" value="No" type="radio" name="intolerances">
																...
																<div class="row">
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="alergies rc" <?php if($row->trackDiet=='No' || $row->trackDiet=='') { echo 'checked=""'; } ?>
			...
			<div class="tab-pane" role="tabpanel" id="step5">
																...
																<div class="row">
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="trackHeart rc" <?php if($row->activelyTrack=='No' || $row->activelyTrack=='') { echo 'checked=""'; } ?> id="trackCholesterol_No" value="No" type="radio" name="trackCholesterol" >
																...
																<div class="row">
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="trackHeart rc" <?php if($row->trackHeart=='No' || $row->trackHeart=='') { echo 'checked=""'; } ?> id="trackHeart_No" value="No" type="radio" name="trackHeart" >
																...
																<div class="row">
																	...
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="trackBlookPressure rc" <?php if($row->trackBlookPressure=='No' || $row->trackBlookPressure=='') { echo 'checked=""'; } ?> id="trackBlookPressure_No" value="No" type="radio" name="trackBlookPressure">
														...
														<div class="form-group">
																<div class="row">
																	...
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		<label>Angina or heart attack in a 1st degree relative < 60 ?</label>
																		<div class="radio-group">
																			<div class="md-radio md-radio-inline">
																				<input class="heartAttactdegreeRelativelessSixty" <?php if($row->heartAttactdegreeRelativelessSixty=='Yes') { echo 'checked=""'; } ?> id="heartAttactdegreeRelativelessSixty_Yes" value="Yes" type="radio" name="heartAttactdegreeRelativelessSixty" >
																				<label for="heartAttactdegreeRelativelessSixty_Yes">Yes</label>
																			</div>
																			<div class="md-radio md-radio-inline">
																				<input class="heartAttactdegreeRelativelessSixty" <?php if($row->heartAttactdegreeRelativelessSixty=='No' || $row->heartAttactdegreeRelativelessSixty=='') { echo 'checked=""'; } ?> id="heartAttactdegreeRelativelessSixty_No" value="No" type="radio" name="heartAttactdegreeRelativelessSixty" >
																				<label for="heartAttactdegreeRelativelessSixty_No">No</label>
																			</div>
																		</div>
																	</div>
																	<div class="clearfix"></div>
																...
																<div class="row">
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="chronicKidneyDisease" <?php if($row->chronicKidneyDisease=='No' || $row->chronicKidneyDisease=='') { echo 'checked=""'; } ?> id="chronicKidneyDisease_No" value="No" type="radio" name="chronicKidneyDisease" >
																	...
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			<div class="md-radio md-radio-inline">
																				<input class="atrialFibrillation" <?php if($row->atrialFibrillation=='Yes') { echo 'checked=""'; } ?> id="atrialFibrillation_Yes" value="Yes" type="radio" name="atrialFibrillation" >
																				<label for="atrialFibrillation_Yes">Yes</label>
																			</div>
																			<div class="md-radio md-radio-inline">
																				<input class="atrialFibrillation" <?php if($row->atrialFibrillation=='No' || $row->atrialFibrillation=='') { echo 'checked=""'; } ?> id="atrialFibrillation_No" value="No" type="radio" name="atrialFibrillation" >
																				<label for="atrialFibrillation_No">No</label>
																			</div>
																		</div>
																	</div>
																	<div class="clearfix"></div>
																...
																<div class="row">
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="bloodPressureTreatment" <?php if($row->bloodPressureTreatment=='No' || $row->bloodPressureTreatment=='') { echo 'checked=""'; } ?> id="bloodPressureTreatment_No" value="No" type="radio" name="bloodPressureTreatment" >
																	...
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			<div class="md-radio md-radio-inline">
																				<input class="rheumatoidArthritis" <?php if($row->rheumatoidArthritis=='Yes') { echo 'checked=""'; } ?> id="rheumatoidArthritis_Yes" value="Yes" type="radio" name="rheumatoidArthritis" >
																				<label for="rheumatoidArthritis_Yes">Yes</label>
																			</div>
																			<div class="md-radio md-radio-inline">
																				<input class="rheumatoidArthritis" <?php if($row->rheumatoidArthritis=='No' || $row->rheumatoidArthritis=='') { echo 'checked=""'; } ?> id="rheumatoidArthritis_No" value="No" type="radio" name="rheumatoidArthritis" >
																				<label for="rheumatoidArthritis_No">No</label>
																			</div>
																		</div>
																...
																<div class="row">
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="trackHeart rc" <?php if($row->testicular_cancer=='No' || $row->testicular_cancer=='') { echo 'checked=""'; } ?> id="testicular_No" value="No" type="radio" name="testicular_cancer" >
																...
																<div class="row">
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="trackHeart rc" <?php if($row->prostateCancer=='No' || $row->prostateCancer=='') { echo 'checked=""'; } ?> id="prostate_No" value="No" type="radio" name="prostateCancer" >
																...
																<div class="row">
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			...
																			<div class="md-radio md-radio-inline">
																				<input class="trackHeart rc" <?php if($row->ovarian_cancer=='No' || $row->ovarian_cancer=='') { echo 'checked=""'; } ?> id="ovarian_cancer_No" value="No" type="radio" name="ovarian_cancer" >
															...
															<div class="form-group">
																<div class="row">
																	<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																		...
																		<div class="radio-group">
																			<div class="md-radio md-radio-inline">
																				<input class="medical rc" <?php if($row->trackMedical=='Yes') { echo 'checked=""'; } ?> id="medical_Yes" value="Yes" type="radio" name="medical" >
													...
													<div class="add_detail medical_detail <?php if($row->trackMedical=='Yes') { echo 'show'; } ?>">
													...
													<ul>
														...
														<li>
														<input type="checkbox" value="high blood pressure" name="medical_conditions[]"> high blood pressure
														</li>
														<li>
														<input type="checkbox" value="heart disease" name="medical_conditions[]"> heart Chronic kidney disease 3
														</li>
													
														<li>
														<input type="checkbox" value="Chronic kidney disease 4" name="medical_conditions[]"> Chronic kidney disease 4
														</li>
														<li>
														<input type="checkbox" value="Chronic kidney disease 5" name="medical_conditions[]"> Chronic kidney disease 5
														</li>
														<li>
											...
											<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
												...
												<div class="radio-group">
													...
													<div class="md-radio md-radio-inline">
														<input class="medi_his rc" <?php if($row->track_family_med=='No' || $row->track_family_med=='') { echo 'checked=""'; } ?>
													...
													<div class="add_detail medi_his_detail <?php if($row->track_family_med=='Yes') { echo 'show'; } ?>" id="medi_his_detail">
	...
	<script type="text/javascript">
		...
		$('.ethnicity option[value="<?=$row->ethnicity?>"]').prop('selected', true);
