										...
										<div class="row">
											<div class="col-lg-3 text-center">
												...
												<div class="body-info">
													...
													<div class="b_ans"><?php if ($row->excericseAvgWeek > 0) {
																			echo number_format($row->excericseAvgWeek) . '/Week';
																		} else {
																			echo '---';
																		} ?></div>
												...
												<div class="body-info">
													...
													<div class="b_ans"><?php if ($row->sleepPerNight > 0) {
																			echo number_format($row->sleepPerNight) . ' Hours';
																		} else {
																			echo '---';
																		} ?></div>
												...
												<div class="body-info">
													<i class="fa fa fa-hospital-o fa-2x"></i><br />
													<label>Steps</label>
													<div class="b_ans"><?php if ($row->stepAvgDay > 0) {
																			echo number_format($row->stepAvgDay) . '/Day';
																		} else {
																			echo '---';
																		} ?></div>
												...
												<div class="body-info">
													<i class="fa fa fa-hospital-o fa-2x"></i><br />
													<label>Water</label>
													<div class="b_ans"><?php if ($row->waterAvgDay > 0) {
																			echo number_format($row->waterAvgDay) . '/Day';
																		} else {
																			echo '---';
																		} ?></div>
											...
											<div class="col-lg-3 text-center">
												...
												<div class="body-info">
													...
													<div class="b_ans"><?php if ($row->bloodPressure > 0) {
																			echo number_format($row->bloodPressure) . ' mmHg';
																		} else {
																			echo '---';
																		} ?></div>
