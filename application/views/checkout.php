										...
										<div class="single-service m-bottom0">
											<form id="frm_checkout" action="<?= base_url('checkout/process_payment') ?>">
												<div class="form-group">
													<label>Email</label>
													<input type="text" class="form-control" id="inp_orderEmail" name="orderEmail" value="<?php if (isset($_POST['orderEmail'])) {
																																				echo $_POST['orderEmail'];
																																			} else {
																																				if (isset($this->session_data)) {
																																					echo $this->session_data->userEmail;
																																				}
																																			} ?>">
												</div>
												...
												<div class="form-group">
													<div class="row">
														<div class="col-md-6 col-xs-12">
															...
															<input type="text" name="first_name" id="inp_first_name" class="form-control" value="<?php if (isset($_POST['first_name'])) {
																																						echo $_POST['first_name'];
																																					} else {
																																						if (isset($this->session_data)) {
																																							echo $this->session_data->userFirstName;
																																						}
																																					} ?>">
														</div>
														<div class="span1"></div>
														<div class="col-md-6 col-xs-12">
															...
															<input type="text" name="last_name" id="inp_last_name" class="form-control" value="<?php if (isset($_POST['last_name'])) {
																																					echo $_POST['last_name'];
																																				} else {
																																					if (isset($this->session_data)) {
																																						echo $this->session_data->userLastName;
																																					}
																																				} ?>">
														</div>
														<div class="clearfix"></div>
												...
												<div class="form-group">
													...
													<input type="text" class="form-control" id="inp_orderPhone" name="orderPhone" onkeypress="return isNumber(event)" value="<?php if (isset($_POST['orderPhone'])) {
																																													echo $_POST['orderPhone'];
																																												} else {
																																													if (isset($this->session_data)) {
																																														echo $this->session_data->userPhone;
																																													}
																																												} ?>">
												</div>
												<div class="form-group">
													<label>Address 1</label>
													<input type="text" class="form-control" id="inp_orderShipAddress" name="orderShipAddress" value="<?php if (isset($_POST['orderShipAddress'])) {
																																							echo $_POST['orderShipAddress'];
																																						} else {
																																							if (isset($this->session_data)) {
																																								echo $this->session_data->user_address1;
																																							}
																																						} ?>" />
												</div>
												<div class="form-group">
													<label>Address 2</label>
													<input type="text" class="form-control" id="inp_orderShipAddress2" name="orderShipAddress2" value="<?php if (isset($_POST['orderShipAddress2'])) {
																																							echo $_POST['orderShipAddress2'];
																																						} else {
																																							if (isset($this->session_data)) {
																																								echo $this->session_data->user_address2;
																																							}
																																						} ?>" />
												</div>
												<div class="form-group">
													<div class="row">
														<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
															<label>City</label>
															<input type="text" class="form-control" id="inp_orderCity" name="orderCity" value="<?php if (isset($_POST['orderCity'])) {
																																					echo $_POST['orderCity'];
																																				} else {
																																					if (isset($this->session_data)) {
																																						echo $this->session_data->user_city;
																																					}
																																				} ?>" />
														</div>
														<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
															<label>Country</label>
															<input type="text" class="form-control" id="inp_orderState" name="orderState" value="<?php if (isset($_POST['orderState'])) {
																																						echo $_POST['orderState'];
																																					} else {
																																						if (isset($this->session_data)) {
																																							echo $this->session_data->user_country;
																																						}
																																					} ?>" />
														</div>
														<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
															<label>Postcode</label>
															<input type="text" class="form-control" onblur="isPostal(this)" placeholder="HA8 5HG" id="orderPostalCode" name="orderPostalCode" value="<?php if (isset($_POST['orderPostalCode'])) {
																																																			echo $_POST['orderPostalCode'];
																																																		} else {
																																																			if (isset($this->session_data)) {
																																																				echo $this->session_data->user_post_code;
																																																			}
									...
									<div class="single-product shop-sidebar">
											...
											<div class="shopping-cart checkout-cart-mb">
												...
												?>
														<div class="item" id="row_<?= $item['options']['ref'] ?>">
															...
															if (
																$item['options']['regularType'] == "Month" || $item['options']['regularType'] == "Quarterly"
															...
															<div class="total-price" style="width: 25%;"><?php echo date("d-m-Y", strtotime($item['scheduleDate'][0])); //echo date('d F Y',strtotime($item['scheduleDate'][0])); 
																											?></div>
															<?php if (
																$item['options']['regularType'] == "Month" || $item['options']['regularType'] == "Quarterly"
																|| $item['options']['regularType'] == "Semi Annually"
										...
										<div class="alert alert-warning" role="alert">
											...
											if ($cart_data) { ?>
												...
												<b>Total </b> &nbsp; £<span class="total_span"><?php $ftotal = $finalTotal - $discount;
																								echo number_format($ftotal, 2); ?></span>
