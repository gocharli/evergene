															...
															<div class="card-header">
																<div class="row">					
																	<div class="col-lg-12">
																		...
																		<!-- <input name="upload_result4_up" type="file" name="result4File[]" multiple /> -->
																...
																<div class="card-block">
																				...
																				<h4 style="text-decoration: underline;"><?php echo $res->marker_title;?></h4>
																					<div class="row col-lg-12">
																						...
																						<div class="col-lg-12">
																							...
																							?>
																								<?php if($results[0]->testResultType != 'Result 3') { echo $res->topText; }?>
																							<?php
																								}
																								else{
																							?>
																								...
																								<?php if($results[0]->testResultType == 'Result 4'){ ?>
																									<!-- <div class="row">
																										<div class="col-lg-12">
																											...
																											<input name="upload_result4_up" type="file" name="result4File[]" multiple />
																											<form id="upload_result4_form" method="post" action="<?php echo base_url(); ?>admin/order_items/upload_result4" enctype="multipart/form-data">
																												<input id="testLogo1" name="upload_result4_up" type="file" name="result4File[]" multiple />
																												<input type="hidden" name="detailId_up" value="<?php echo $results[0]->detailId;?>" />
																												<input id="upload_result4_btn" type="submit" style="display: none" />
																											</form>
																										</div>
																												...
																												<fieldset class="form-control">
																													...
																													<div class="row">
																														<div class="col-lg-3">
																															...
																															<textarea name="standard[]" id="standard_<?php echo $res->resultId; ?>" class="col-sm-12 form-control"><?php echo $res->topText; //echo $marker->tm_standard_description; ?></textarea>
																														</div>
																														<div class="col-lg-3">
																	...
																	<?php }else if($results[0]->testResultType == 'Result 3'){ ?>
																		...
																		<div style="">
																			...
																			<?php $j=1; foreach ($results as $res){ ?>
...
function get_report(marker_title, testId){
		...
		$.ajax({
			...
			dataType: 'json',
			data:{'marker_title':marker_title, 'testId': testId, 'user_id':user_id},
			method: 'post'
																				...
																				<div class="col-lg-12 col-xl-6">
																					<table class="table m-0">
																							...
																							<td>
																								...
																								<?php if($order_details->detailStatus=='Pending')
																								{
																									...
																									if($order_details->scheduleDate >= date('Y-m-d')){
																										...
																										echo '<label class="label label-primary">Pending hhhh</label>';
																									}
																								}
																						...
																						<tr>
																							...
																							<td> <?php if($order_details->regularType == 'One Time') echo '1'; else echo $order_details->detailQty; // echo $order_details->detailQty; ?></td>
																						</tr>
																						<tr>
...
<script type="text/javascript">
	...
	function remove_file(detailId, file){
		...
		if(confirm("Are you sure! Delete file ?")){
			...
			$.ajax({
				...
				type: "POST",
				data: {"detailId": detailId, "file": file},
	...
	function update_result3(resultId, result3){
		...
		// 	type: "POST",
		// 	data: {"resultId": resultId, "result3": result3},
		// 	success: function (resp) {
		// 		if(resp == 1){
		// 			$.confirm({
		// 				title: 'Success!',
	...
	function update_result3_desc(resultId){
		...
		$.ajax({
			url: "<?=base_url()?>admin/orders_items/update_result3",
			type: "POST",
			data: {"resultId": resultId, "result3": result3, "topText": topText, "bottomText": bottomText},
			success: function (resp) {
				if(resp == 1){
					$.confirm({
						title: 'Success!',
