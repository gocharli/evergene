							...
							<div class="row align-items-center">
								<div class="col-md-8">
									...
									<ul class="breadcrumb">
										...
										<li class="breadcrumb-item"><a href="javascript:;">Meal prep</a>
										</li>
									</ul>
								</div>
							</div>
								...
								<div class="page-body">
									...
									<div class="card">
										<div class="card-header">
											<h5>Meal prep</h5>
											<span>Meal prep Management</span>
										</div>
...
<script type="text/javascript">
	...
	$('#dt-server-processing').DataTable({
		...
		"order": [[ 0, "desc" ]],
		"ajax":{
			"url": admin_url+"mealprep/list_data",
			"dataType": "json",
			"type": "POST",
			"data":{ }
		},
						...
						action: function(){
							...
							$.confirm({
								...
								content: function () {
									var self = this;
									return $.ajax({
										url: admin_url+"mealprep/change_status",
										dataType: 'json',
