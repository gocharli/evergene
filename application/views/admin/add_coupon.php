							...
							<div class="row align-items-center">
								<div class="col-md-8">
									...
									<ul class="breadcrumb">
										...
										<li class="breadcrumb-item">
											<a href="javascript:;">Add Coupon</a>
										</li>
									</ul>
								</div>
							</div>
										...
										<div class="col-sm-12">
											<div class="card">
												<div class="card-header">
													<h5>Add Coupon</h5>
													<span>add Coupon information</span>
												</div>
												<div class="card-block">
													<div class="j-wrapper j-wrapper-640">
														<form id="frm_1" action="<?=$this->config->item('admin_url')?>/coupons/add_process" method="post" class="j-pro">
															<div class="j-content">
																...
																<div class="j-unit">
																	...
																	<div class="j-input">
																		...
																		<input type="number" id="percentage" class="form-control" name="percentage" max="100" required="true">
																...
																<div class="j-unit">
																	...
																	<div class="j-input">
																		...
																		<input type="number" class="form-control" id="frequency" name="frequency" required="true">
																...
																<div class="j-unit">
																	<label class="j-label">Package</label>
																		...
																		<?php foreach($coupons as $c){ ?>
																			<option value="<?php echo $c->mpId; ?>"><?php echo $c->planTitle; ?></option>
																		<?php } ?>
