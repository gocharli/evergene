																				...
																				<div class="j-unit">
																					...
																					<div class="j-input form-radio" style="margin-top: 15px;">
																						<div class="radio radio-inline">
																							<label>
																								<input type="radio" name="setting_<?= $row->settingID ?>" value="1" <?php if ($row->settingValue == '1') {
																																										echo 'checked=""';
																																									} ?>>
																						...
																						<div class="radio radio-inline">
																							<label>
																								<input type="radio" name="setting_<?= $row->settingID ?>" value="0" <?php if ($row->settingValue == '0') {
																																										echo 'checked=""';
																																									} ?>>
																								<i class="helper"></i>No
																							</label>
