								...
								<div class="row align-items-center">
									<div class="col-md-8">
										<div class="page-header-title">
											<h4 class="m-b-10">Add General item</h4>
										</div>
										<ul class="breadcrumb">
											...
											<li class="breadcrumb-item">
												<a href="javascript:;">Add General item</a>
											</li>
										</ul>
									</div>
								</div>
											...
											<div class="col-sm-12">
												<div class="card">
													<div class="card-header">
														...
														<span>add General item information</span>
													</div>
													<div class="card-block">
														<div class="j-wrapper j-wrapper-640">
															<form id="frm_1" action="<?= $this->config->item('admin_url') ?>/items/add_process" method="post" class="j-pro j-multistep" novalidate>
																<div class="j-content">
																	<fieldset>
