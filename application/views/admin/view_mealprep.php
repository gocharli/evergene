								...
								<div class="row align-items-center">
									<div class="col-md-8">
										<div class="page-header-title">
											<h4 class="m-b-10">View Meal Prep</h4>
										</div>
										<ul class="breadcrumb">
											...
											<li class="breadcrumb-item">
												<a href="javascript:;">View Mmeal prep</a>
											</li>
										</ul>
									</div>
								</div>
																	...
																	<div class="col-lg-12 product-right">
																		<div id="small_banner">
																			...
																			if ($imoreImages) {
																				foreach ($imoreImages as $image) { ?>
																					<div>
																						<img class="img img-fluid" src="<?= base_url() . '/uploads/tests/products/' . $image->imageName ?>" style="height: 80px;" alt="small">
																					</div>
																			<?php
																				}
																			} ?>
										...
										<div class="card product-detail-page">
											<ul class="nav nav-tabs md-tabs tab-timeline" role="tablist">
												...
												<li class="nav-item m-b-0">
													<a class="nav-link f-18 p-b-0" data-toggle="tab" href="#review" role="tab">Menu</a>
													<div class="slide"></div>
												</li>
												<li class="nav-item m-b-0">
													<a class="nav-link f-18 p-b-0" data-toggle="tab" href="#sizeguide" role="tab">How its works</a>
													<div class="slide"></div>
												</li>
											</ul>
										</div>
