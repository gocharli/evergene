										...
										<div class="col-sm-12">
											<div class="card">
												<div class="card-header">
													<h5>Add Blog</h5>
													<span>add Blog information</span>
												</div>
												<div class="card-block">
													<div class="j-wrapper j-wrapper-640">
														<form id="frm_1" action="<?=$this->config->item('admin_url')?>/blogs/add_process" method="post" class="j-pro">
															<div class="j-content">
																...
																<div class="j-unit">
																	...
																	<div class="j-input">
																		...
																		<input type="text" id="blogTitle" onfocusout="update_slug(this.value)" name="blogTitle">
																...
																<div class="j-unit">
																	...
																	<div class="j-input">
																		...
																		<input type="text" id="blogSlug" onfocusout="update_pageURL(this.value)" name="blogSlug">
																...
																<div class="j-unit">
																	...
																	<div class="j-input">
																		...
																		<input id="pageURL" disabled type="text" value="<?php echo base_url(); ?>blog/view/">
																...
																<div class="j-unit">
																	...
																	<div class="j-input">
																		...
																		<input type="text" id="PicAltText" name="PicAltText">
																...
																<div class="j-unit">
																	...
																	<div class="j-input">
																		<textarea spellcheck="false" id="blogDescription" name="blogDescription"></textarea>
																	</div>
																</div>
																<div class="card">
																	<div class="card-header">
