							...
							<div class="row align-items-center">
								<div class="col-md-8">
									<div class="page-header-title">
										<h4 class="m-b-10">Edit Test Result (STEP I)</h4>
									</div>
									<ul class="breadcrumb">
									...
									$.confirm({
										...
										buttons: {
											ok: {
												...
												btnClass: 'btn-red',
												action: function(){
													window.location = "<?php echo base_url().'admin/orders_items/index/completed'?>";
												}
									...
									$.confirm({
										...
										buttons: {
											ok: {
												...
												btnClass: 'btn-green',
												action: function(){
													window.location = "<?php echo base_url().'admin/orders_items/view/'.$detailId?>";
												}
