															...
															<div class="j-content">
																<fieldset>
																		...
																		<div class="j-span6 j-unit">
																			...
																			<div class="j-input form-radio" style="margin-top: 15px;">
																				<div class="radio radio-inline">
																					<label>
																						<input type="radio" id="discountPercentageYes" name="discountPercentage" value="Yes" <?php if($row->discountPercentage=='Yes') { echo 'checked=""'; } ?> >
																						<i class="helper"></i>Yes
																					</label>
																				</div>
																				<div class="radio radio-inline">
																					<label>
																						<input type="radio" id="discountPercentageNo" name="discountPercentage" value="No" <?php if($row->discountPercentage=='No') { echo 'checked=""'; } ?>>
																						<i class="helper"></i>No
																					</label>
																				</div>
																			</div>
                                                                    ...
                                                                    <!--<div class="j-unit">
																			...
																			<div class="j-input form-radio" style="margin-top: 15px;">
																				<div class="radio radio-inline">
																					<label>
																						<input type="radio" name="resultHistory" value="Yes" <?php if($row->resultHistory=='Yes') { echo 'checked=""'; } ?> >
																						<i class="helper"></i>Yes
																					</label>
																				</div>
																				<div class="radio radio-inline">
																					<label>
																						<input type="radio" name="resultHistory" value="No" <?php if($row->resultHistory=='No') { echo 'checked=""'; } ?>>
																						<i class="helper"></i>No
																					</label>
																				</div>
																			</div>
																...
																<fieldset>
																	...
																	<!-- <div class="j-unit">
																		...
																		<div class="j-input">
																			<input type="number" name="noOfMarkers" min="1" max="100" class="col-sm-6" id="noOfMarkers" value="<?=$row->no_of_markers;?>" readonly>
																		</div>
																	</div> -->
																	...
																	<div id="marker">
																		...
																		?>
																					...
																					<br>
																					<div class="row" style="<?php if($row->testResultType == 'Result 3'){ echo 'display:none'; } ?>" >
																						<div class="col-lg-6">
																							<div class="j-unit">
