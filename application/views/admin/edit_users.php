                                                                ...
                                                                <div class="j-unit">
																	...
																	<div class="j-input form-radio" style="margin-top: 15px;">
																		<div class="radio radio-inline">
																			<label>
																				<input type="radio" name="userGender" value="Male" <?php if($row->userGender=='Male') { echo 'checked=""'; } ?> >
																				<i class="helper"></i>Male
																			</label>
																		</div>
																		<div class="radio radio-inline">
																			<label>
																				<input type="radio" name="userGender" value="Female" <?php if($row->userGender=='Female') { echo 'checked=""'; } ?>>
