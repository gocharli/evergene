							...
							<div class="row align-items-center">
								<div class="col-md-8">
									<div class="page-header-title">
										<h4 class="m-b-10">Edit General Item</h4>
									</div>
									<ul class="breadcrumb">
										...
										<li class="breadcrumb-item">
											<a href="<?=$this->config->item('admin_url')?>/items">
												General Items
											</a>
										</li>
										<li class="breadcrumb-item">
											<a href="javascript:;">Edit General Item</a>
										</li>
									</ul>
								</div>
							</div>
											...
											<div class="card">
												...
												<div class="card-block">
													<div class="j-wrapper j-wrapper-640">
														<form id="frm_1" action="<?=$this->config->item('admin_url')?>/items/edit_process/<?=$row->testId?>" method="post" class="j-pro j-multistep" novalidate>
															<div class="j-content">
																<fieldset>
																		...
																		<div class="j-span6 j-unit">
																			...
																			<div class="j-input form-radio" style="margin-top: 15px;">
																				<div class="radio radio-inline">
																					<label>
																						<input type="radio" name="discountPercentage" value="Yes" <?php if($row->discountPercentage=='Yes') { echo 'checked=""'; } ?> >
																						<i class="helper"></i>Yes
																					</label>
																				</div>
																				<div class="radio radio-inline">
																					<label>
																						<input type="radio" name="discountPercentage" value="No" <?php if($row->discountPercentage=='No') { echo 'checked=""'; } ?>>
																						<i class="helper"></i>No
																					</label>
																				</div>
																			</div>
					...
					action: function(){
						...
						$.confirm({
							...
							content: function () {
								var self = this;
								return $.ajax({
									url: "<?php echo base_url(); ?>admin/items/delete_img",
									dataType: 'json',
									data:{id:id},
									method: 'post'
								}).done(function (response) {
