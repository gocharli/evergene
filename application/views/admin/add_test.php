															...
															<div class="j-content">
																<fieldset id="f1">
																	...
																	<div class="j-row">
																		...
																		<div class="j-span6 j-unit">
																			<label class="j-label">Discount</label>
																			<div class="j-input">
                                                                    ...
                                                                    <div class="j-unit j-span4">
																			...
																			<div class="j-input j-select">
																				<select class="js-example-basic-single" name="testResultType" id="r_type" style="width: 100% !important; height:30px!important">
																	...
																	<div class="j-unit j-span4">
																			...
																			<div class="j-input form-radio" style="margin-top: 15px;">
																				<div class="radio radio-inline">
																					<label>
																						<input type="radio" name="coming_soon" value="1" onclick="show2();">
																						<i class="helper"></i>Yes
																					</label>
																				</div>
																				<div class="radio radio-inline">
																					<label>
																						<input type="radio" name="coming_soon" value="0" checked onclick="show1();">
																						<i class="helper"></i>No
																					</label>
																				</div>
																			</div>
																	...
																	<div class="j-unit j-span-12" id="div1"  style="display:none">
																		<label class="j-label">Enter Date</label>
																		<div class="j-input">
																		<input type="date" name="coming_soon_date" id="sampleTakeen" class="form-control" required="true">
																	...
																	<div class="j-unit">
																		...
																		<div class="j-input">
																			...
																			<input type="text" id="" name="price_to_supplier">
																...
																<fieldset id="f2">
																	...
																	<!-- <input id="tab_cnt" type="text" value="1" /> -->
																...
																<fieldset id="f3">
																	...
																	<div class="j-unit">
																		...
																		<div class="j-input">
																			...
																			<input type="hidden" id="is_type_4" value="0" />
...
// 		var tab = $('#f3').attr('class'); // j-active-fieldset
// 		var is_type_4 = $("#is_type_4").val();
		
// 		if(tab == 'j-active-fieldset' && is_type_4 == 1){
		    
		    
// // 			//alert('enter in if cond');
// // 			$('#f1').removeClass('j-active-fieldset');
// // 			$('#f2').removeClass('j-active-fieldset');
// // 			$('#f3').removeClass('j-active-fieldset');
// // 			$('#f4').addClass('j-active-fieldset');

// // 			$(".j-multi-next-btn").hide();
// // 			$('.j-hiddenBtn').attr('style','display: block !important');			
// 		}
// 	});

// // 	$(".j-multi-prev-btn").click(function(e){
// // 		var tab = $('#f3').attr('class');
// // 		//alert(tab); // j-active-fieldset
// // 		var is_type_4 = $("#is_type_4").val();
// // 		//alert(no_mrk);
// // 		if(tab == 'j-active-fieldset' && is_type_4 == 1){
// // 			$('#f1').removeClass('j-active-fieldset');
// // 			$('#f3').removeClass('j-active-fieldset');
// // 			$('#f4').removeClass('j-active-fieldset');

// // 			$('#f2').addClass('j-active-fieldset');
// // 			$(".j-hiddenBtn").hide();
// // 			$('.j-multi-next-btn').attr('style','display: block !important');
// // 		}
// // 	});
...
$("#r_type").change( function(e){
	...
	if(r_type== 'Result 4' || r_type== 'Result 3'){  // set default values for result type 4	
		//var newOption = new Option('f', 'f', true, true);    
		//$("#testMarkers").append(newOption).trigger('change');
		//$("#noOfMarkers").val(0);
		$("#is_type_4").val(1);
		//$("#mrkr_tb").hide();
	}else{
		//$('#testMarkers').val(null).trigger('change');
		//$("#noOfMarkers").val("");
		$("#is_type_4").val(0);
	}
});
...
<script type="text/javascript"> 
		...
		function addOBXMarkers(){
			...
			//alert($('select[name="testResultType"]').val());
			...
			if(markers_limit<=100){
        		...
        		if(is_type_4 == 1){
        		    ...
        		    for (var i=0; i<markers_limit; i++) {
    	        		...
    	        		var r_type = $("#r_type").val();
	                    if(r_type== 'Result 4'){
    	        		    $('#marker').append('<div style="display:none"><br><strong style="color: green;">'+number+' -</strong><hr><div class="row"><div class="col-lg-7"><div class="j-unit"><label class="j-label">Marker Title</label><div class="j-input"><input type="text" value="marker'+number+'" name="markerTitle[]" id="markerTitle" class="col-sm-12"><span class="j-tooltip j-tooltip-right-top">Enter Marker Title</span></div></div></div><div class="col-lg-5"><div class="j-unit"><label class="j-label">Marker Unit</label><div class="j-input"><input type="text" name="markerUnit[]" id="markerUnit" value="0" class="col-sm-12"><span class="j-tooltip j-tooltip-right-top">Enter Marker Unit</span></div></div></div></div><br><div class="row"><div class="col-lg-3"><div class="j-unit"><label class="j-label">Min Value</label><div class="j-input"><input type="text" name="minValue[]" id="minValue" value="0" class="col-sm-12 decimal"><span class="j-tooltip j-tooltip-right-top">Enter Marker Min Value</span></div></div></div><div class="col-lg-3"><div class="j-unit"><label class="j-label">Lower Value</label><div class="j-input"><input type="text" name="lowerValue[]" id="lowerValue" value="0" class="col-sm-12 decimal"><span class="j-tooltip j-tooltip-right-top">Enter Marker Lower Value</span></div></div></div><div class="col-lg-3"><div class="j-unit"><label class="j-label">Upper Value</label><div class="j-input"><input type="text" name="upperValue[]" id="upperValue" value="0" class="col-sm-12 decimal"><span class="j-tooltip j-tooltip-right-top">Enter Marker Upper Value</span></div></div></div><div class="col-lg-3"><div class="j-unit"><label class="j-label">Max Value</label><div class="j-input"><input type="text" name="maxValue[]" id="maxValue" value="0" class="col-sm-12 decimal"><span class="j-tooltip j-tooltip-right-top">Enter Marker Max Value</span></div></div></div></div><br><div class="row"><div class="col-lg-4"><div class="j-unit"><label class="j-label">Standard Description</label><div class="j-input"><textarea name="standard[]" id="standard" value="its result type 3 or 4 description" class="col-sm-12">its result type 3 or 4 description</textarea><span class="j-tooltip j-tooltip-right-top">Enter Marker Standard Value</span></div></div></div><div class="col-lg-4"><div class="j-unit"><label class="j-label">Normal Result</label><div class="j-input"><textarea name="normal[]" id="normal" value="its result type 3 or 4 description" class="col-sm-12">its result type 3 or 4 description</textarea><span class="j-tooltip j-tooltip-right-top">Enter Marker Normal Description</span></div></div></div><div class="col-lg-4"><div class="j-unit"><label class="j-label">Abnormal Result</label><div class="j-input"><textarea name="abnormal[]" id="abnormal" value="its result type 3 or 4 description" class="col-sm-12">its result type 3 or 4 description</textarea><span class="j-tooltip j-tooltip-right-top">Enter Marker Abnormal Description</span></div></div></div></div><hr></div>');
	                    }else{
	                        $('#marker').append('<div><br><strong style="color: green;">'+number+' -</strong><hr><div class="row"><div class="col-lg-7"><div class="j-unit"><label class="j-label">Marker Title</label><div class="j-input"><input type="text" value="marker'+number+'" name="markerTitle[]" id="markerTitle" class="col-sm-12"><span class="j-tooltip j-tooltip-right-top">Enter Marker Title</span></div></div></div><div class="col-lg-5"><div class="j-unit"><label class="j-label">Marker Unit</label><div class="j-input"><input type="text" name="markerUnit[]" id="markerUnit" value="0" class="col-sm-12"><span class="j-tooltip j-tooltip-right-top">Enter Marker Unit</span></div></div></div></div><br><div class="row" style="display: none"><div class="col-lg-3"><div class="j-unit"><label class="j-label">Min Value</label><div class="j-input"><input type="text" name="minValue[]" id="minValue" value="0" class="col-sm-12 decimal"><span class="j-tooltip j-tooltip-right-top">Enter Marker Min Value</span></div></div></div><div class="col-lg-3"><div class="j-unit"><label class="j-label">Lower Value</label><div class="j-input"><input type="text" name="lowerValue[]" id="lowerValue" value="0" class="col-sm-12 decimal"><span class="j-tooltip j-tooltip-right-top">Enter Marker Lower Value</span></div></div></div><div class="col-lg-3"><div class="j-unit"><label class="j-label">Upper Value</label><div class="j-input"><input type="text" name="upperValue[]" id="upperValue" value="0" class="col-sm-12 decimal"><span class="j-tooltip j-tooltip-right-top">Enter Marker Upper Value</span></div></div></div><div class="col-lg-3"><div class="j-unit"><label class="j-label">Max Value</label><div class="j-input"><input type="text" name="maxValue[]" id="maxValue" value="0" class="col-sm-12 decimal"><span class="j-tooltip j-tooltip-right-top">Enter Marker Max Value</span></div></div></div></div><br><div class="row"><div class="col-lg-4"><div class="j-unit"><label class="j-label">Standard Description</label><div class="j-input"><textarea name="standard[]" id="standard" value="" class="col-sm-12"></textarea><span class="j-tooltip j-tooltip-right-top">Enter Marker Standard Value</span></div></div></div><div class="col-lg-4"><div class="j-unit"><label class="j-label">Negative Result</label><div class="j-input"><textarea name="normal[]" id="normal" value="" class="col-sm-12"></textarea><span class="j-tooltip j-tooltip-right-top">Enter Marker Normal Description</span></div></div></div><div class="col-lg-4"><div class="j-unit"><label class="j-label">Positive Result</label><div class="j-input"><textarea name="abnormal[]" id="abnormal" value="" class="col-sm-12"></textarea><span class="j-tooltip j-tooltip-right-top">Enter Marker Positive Description</span></div></div></div></div><hr></div>');
	                    }
