...
<!-- Style.css --><link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/front/ex_css/bootstrap-datetimepicker.min.css"/>
							...
							<div class="row align-items-center">
								<div class="col-md-8">
									...
									<ul class="breadcrumb">
										...
										<li class="breadcrumb-item">
											<a href="javascript:;">Add Member</a>
										</li>
									</ul>
								</div>
							</div>
										...
										<div class="col-sm-12">
											<div class="card">
												<div class="card-header">
													<h5>Add Member</h5>
													<span>add Member information</span>
												</div>
												<div class="card-block">
													<div class="j-wrapper j-wrapper-640">
														<form id="frm_1" action="<?=$this->config->item('admin_url')?>/members/add_process" method="post" class="j-pro">
															<div class="j-content">
																...
																<div class="j-unit">
																	...
																	<div class="j-input">
																		...
																		<span class="j-tooltip j-tooltip-right-top">Enter email</span>
																	</div>
																</div>
																...
																<div class="j-unit">
																	...
																	<div class="j-input">
																		<label class="j-icon-right" for="userPassword">
																			<i class="icofont icofont-ui-lock"></i>
																		</label>
																		<input type="password" id="userPassword" name="userPassword">
																		<span class="j-tooltip j-tooltip-right-top">Enter password</span>
																	</div>
																</div>
                                                                <div class="j-unit">
																	...
																	<div class="j-input">
																		...
																		<input type="text" id="userDob" name="userDob"  value="">
