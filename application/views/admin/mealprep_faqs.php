...
<div class="md-modal md-effect-8" id="modal-8">
	<div class="md-content">
		<h3>ADD FAQ</h3>
		<div>
			<form id="frm_1" action="<?=$this->config->item('admin_url')?>/mealprep/edit_faq_code" method="post" class="j-pro">
				<div class="j-content">
					<div class="j-unit">
...
<div class="md-modal md-effect-8" id="modal-9" tabindex="-1">
	<div class="md-content">
		<h3>FAQs</h3>
		<div>
			<form id="frm_2" action="<?=$this->config->item('admin_url')?>/mealprep/rel_faq_code" method="post" class="j-pro">
				<div class="j-content">
					<div class="j-unit">
						<label class="j-label" style="margin: 15px 0px; font-size: 18px;">Title</label>
...
<script type="text/javascript">
	...
	$('#dt-server-processing').DataTable({
		...
		"order": [[ 0, "desc" ]],
		"ajax":{
			"url": admin_url+"mealprep/list_faqs_data/<?=$row->testId?>",
			"dataType": "json",
			"type": "POST",
			"data":{ }
		},
