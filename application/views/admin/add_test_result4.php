											...
											<form id="uploadResultForm" enctype="multipart/form-data" method="POST">
												...
												?>
															...
															<fieldset class="form-control">
																<div class="row">
															        <div class="col-lg-4">
    																 <h5 style="margin-bottom:5px">Please uplaod result file here</h5>
                													    <div class="card-block upload-file">
                														   <input type="file" name="result4File[]" id="testLogo12" multiple required>
                														</div>
																...
																<div class="row" style="display: none">
																	<div class="col-lg-4">
																		...
																		<textarea name="standard" id="standard" class="col-sm-12 form-control"><?php echo $order_details[0]->tm_standard_description; ?></textarea>
																	</div>
																	<div class="col-lg-4">
																		<label class="j-label">Normal Result</label>
																		<textarea name="normal" id="normal" class="col-sm-12 form-control"><?php echo $order_details[0]->tm_normal_description; ?></textarea>
																	</div>
																	<div class="col-lg-4">
																		<label class="j-label">Abnormal Result</label>
																		<textarea name="abnormal" id="abnormal" class="col-sm-12 form-control"><?php echo $order_details[0]->tm_abnormal_description; ?></textarea>
																	</div>
																</div>
															</fieldset>
												<?php
		...
		$('#uploadResultForm').submit(function(e){
			...
			$.confirm({
				...
				content: function () {
					var self = this;
					return $.ajax({
						url: '<?php echo base_url().'admin/Orders_items/addTestResult4'; ?>',
						dataType: 'json',
						data: formData,
						processData: false,
						contentType: false,
