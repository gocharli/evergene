<header class="theme-menu-wrapper <?php if ($this->router->fetch_class() == 'home') {
										echo 'menu-style-two';
	...
	<div class="header-wrapper" style="padding-top:30px">
		<div class="container">
			...
			<div class="logo float-left tran4s">
				<a href="<?= base_url() ?>"><img src="<?= base_url('assets/front/') ?>images/logo/<?php if ($this->router->fetch_class() == 'home') {
																									echo 'logo2.png';
																								} else {
																									echo 'logo.png';
																								} ?>" alt="Logo"></a>
