	...
	<div class="sidebar-categories">
		<ul>
			...
			<li class="clearfix <?php if($newResults->count>0){echo 'quadrat';} ?>">
				<a href="<?=base_url('results')?>" class="tran3s <?php if($this->router->fetch_class()=='results'){ ?>active<?php } ?>">Your Test Results</a>
			</li>
			<li class="clearfix">
			...
			<li class="clearfix">
				<a href="<?=base_url('orders/upcoming')?>" class="tran3s <?php if($this->router->fetch_class()=='orders' && $this->router->fetch_method()=='upcoming' ){ ?>active<?php } ?>">Your Upcoming Orders</a>
			</li>
			<li class="clearfix">
			...
			<li class="clearfix">
				<a href="<?=base_url()?>account" class="tran3s <?php if($this->router->fetch_class()=='account' && $this->router->fetch_method()=='index' ){ ?>active<?php } ?>">General Settings</a>
			</li>
			<li class="clearfix">
