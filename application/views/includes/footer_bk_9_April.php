	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-3 col-sm-6 col-xs-12">
				...
				<div class="footer-list footer-first-list">
				<ul>
				...
				<div class="modal-body">
					...
					<form id="frm_signup" action="<?=base_url('signup/process')?>" method="post">
						<div class="wrapper p-0">
							...
							<div>
							<span class="agree_msg" style="display: inline-flex;color:#000;margin-top:5px;"> 
							
								

								<?php if($this->uri->segment(1) == 'checkout'){ ?>
									I want to receive emails including special offers and Evergene news.
					        ...
					        <input type="checkbox" name="terms1" id="sign-up-checkbox2"  value="1"/><span class="simple-text">I have read and agree to</span> <a target="_blank" href="<?php echo base_url(); ?>terms_of_use"> Terms and conditions.</a> </br>
