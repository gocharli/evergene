<header class="theme-menu-wrapper <?php if($this->router->fetch_class()=='home') { echo 'menu-style-two';} ?>" style="padding-top:0px">
    <div class="col-md-12 text-center" style="background: #86c44c;">
				    <p class="mem-p" style="color:#fff;margin:0px">Limited time offer: 1 Year premium membership in £140 with code <b>"BUY FREE"</b> <i class="fa fa-times float-right header-cross" aria-hidden="true"></i></p>
	</div>
