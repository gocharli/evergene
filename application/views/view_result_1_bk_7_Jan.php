							...
							<div class="col-lg-12 col-xs-12">
								...
								<div class="single-product shop-sidebar">
									...
									<div class="product-header">
										<h6><img src="<?=base_url('assets/front/')?>images/product/Cholesterol.png" alt=""/>
										    <?=$order_details->testName?> <small>(Date : <?=date('M d,Y',strtotime($order_details->resultReceivedDate))?>)</small>
										</h6>
									...
									<div class="row">
										...
										<div class="col-md-12 col-xs-12 mix technical investment">
											...
											$i=0;
												...
												<div class="clearfix"></div>
												<div class="res_div">Result = <?=$res->resultValue?> <?=$res->resultUnit?></div>
												<div class="clearfix"></div>
												<p><?=$res->bottomText?></p>
