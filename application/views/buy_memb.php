...
<body>
	<div class="main-page-wrapper">
								...
								<div class="col-lg-5 col-xs-6">
									<div class="single-product shop-sidebar">
										...
										<div class="single-service m-bottom0">
											<p><?php $p = $results[0];
												echo ucfirst($p->planPeriod); ?> subscription will be charged on a <?php echo $p->planPeriod; ?> basis and contains <?php echo $p->planOrders; ?> orders per month.</p>
										</div>
											...
											<div class="shopping-cart">
												...
												<div class="item" id="row_zSjduFOO">
													...
													<div class="total-price" style="width: 20%;">
														<?php if ($p->mpId == 2) {
															echo date("d-m-Y", strtotime("+1 year", strtotime($today)));
														} else {
															echo date("d-m-Y", strtotime("+1 month", strtotime($today)));
														} ?>
													</div>
		...
		<form id="mem_form" method="post" action="<?php echo base_url(); ?>memberships/process">
			...
			<input id="free_plan" name="free_plan" type="hidden" value="0" />
		</form>
