	...
	<div class="main-page-wrapper">
												...
												<div class="single-service m-bottom0">
													<form id="frm_1" action="<?php echo base_url(); ?>account/process" method="post">
														...
														<div class="form-group">
															...
															<input id="datetime" type="text" class="form-control" name="userDob" value="<?php if (trim($row->userDob) != '0000-00-00') {
																																			echo date('d-m-Y', strtotime($row->userDob));
																																		} ?>">
														</div>
														...
														<div class="form-group">
															...
															<label class="radio-inline">
																<input type="radio" <?php if ($row->userGender == 'Male') {
																						echo 'checked=""';
																					} ?> style="width: auto !important; height:auto !important;" name="userGender" id="inlineRadio1" value="Male" checked=""> Male
															</label>
															<label class="radio-inline">
																<input type="radio" <?php if ($row->userGender == 'Female') {
																						echo 'checked=""';
																					} ?> style="width: auto !important; height:auto !important;" name="userGender" id="inlineRadio2" value="Female"> Female
															</label>
														</div>
																...
																?>
																	<div class="results-info-list">
																		<ul class="clearfix">
																			...
																			<?php $tchk = 0;
																			if ($membership->StripeSubscriptionEnded > 0) {
																				$tchk = 1; ?>
																				<li>
		...
		<script>
			function update_notifications(type) {
				...
				$.post("<?php echo base_url(); ?>account/update_notifications", {
					type: type,
					noti: noti
				}, function(res) {
