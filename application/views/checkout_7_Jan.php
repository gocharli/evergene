								...
								<div class="single-product shop-sidebar">
									...
									<div class="single-service">
										...
										<div class="shopping-cart">
											<!-- Product #1 -->
                                            <div class="item">                                            
                                                 <div class="description" style="width: 35%;font-size: 15px;font-weight: bold;">Title</div>
    											 <div class="total-price" style="width: 10%;font-size: 15px;font-weight: bold;">Qty</div>
												...
												?>
													<div class="item" id="row_<?= $item['options']['ref']?>">
                                                      ...
                                                      //  echo $item['options']['regularType'];
														...
														<div class="total-price" style="width: 25%;"><?php echo date('d F Y',strtotime($item['scheduleDate'][0])); ?></div>
														...
														<div class="total-price" style="width: 15%;">
															<a href="javascript:;" class="tran3s custom-btn small-btn hvr-trim-two" onclick="del('<?= $item['options']['ref'];?>')"><span class="fa fa-trash-o"></span> </a>
														</div>
													</div>
												<?php
											 $i++;
