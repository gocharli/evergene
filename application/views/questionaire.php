																...
																<div class="form-group">
																	<div class="row">
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			...
																			<input type="text" class="form-control" name="f_name" value="<?php if (empty($row->f_name)) echo $user->userFirstName;
																																			else echo $row->f_name; ?>" readonly onKeyPress="return ValidateAlpha(event);" />
																		</div>
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			<label>Second Name*</label>
																			<input type="text" class="form-control" name="l_name" value="<?php if (empty($row->l_name)) echo $user->userLastName;
																																			else echo $row->l_name; ?>" readonly onKeyPress="return ValidateAlpha(event);" />
																		</div>
																	</div>
																</div>
																...
																<div class="form-group">
																	...
																	<div class="row">
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" id="quest-gender">
																			...
																			<div class="radio-group">
																				<div class="md-radio md-radio-inline">
																					<input disabled class="alergies rc" <?php if ($user->userGender == 'Male' || $user->userGender == '') {
																															echo 'checked';
																														} ?> id="male" value="Male" type="radio" name="gender">
																					<label for="male">Male </label>
																				</div>
																				<div class="md-radio md-radio-inline">
																					<input class="alergies rc" <?php if ($user->userGender == 'Female') {
																													echo 'checked';
																		...
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			...
																			<input type="text" class="form-control" name="dob" readonly value="<?php if (trim($user->userDob) != '0000-00-00') {
																																					echo $user->userDob;
																																				} ?>" />
																		</div>
																		<div class="clearfix"></div>
																	...
																	<div class="row">
																		...
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			...
																			<select name="ethnicity" class="form-control ethnicity">
																				...
																				<option value="White or not stated" <?php if ($row->ethnicity == 'White or not stated') {
																														echo 'selected';
																													} ?>>White or not stated</option>
																				<option value="Asian Indian" <?php if ($row->ethnicity == 'Asian Indian') {
																													echo 'selected';
																												} ?>>Indian</option>
																				<option value="Asian Pakistani" <?php if ($row->ethnicity == 'Asian Pakistani') {
																													echo 'selected';
																												} ?>>Pakistani</option>
																				<option value="Asian Bangladeshi" <?php if ($row->ethnicity == 'Asian Bangladeshi') {
																														echo 'selected';
																													} ?>>Bangladeshi</option>
																				<option value="Other Asian" <?php if ($row->ethnicity == 'Other Asian') {
																												echo 'selected';
																											} ?>>Other Asian</option>
																				<option value="Black Caribbean" <?php if ($row->ethnicity == 'Black Caribbean') {
																													echo 'selected';
																												} ?>>Black Caribbean</option>
																				<option value="Black African" <?php if ($row->ethnicity == 'Black African') {
																													echo 'selected';
																												} ?>>Black African</option>
																				<option value="Asian Chinese" <?php if ($row->ethnicity == 'Asian Chinese') {
																													echo 'selected';
																												} ?>>Chinese</option>
																				<option value="Other" <?php if ($row->ethnicity == 'Other') {
																											echo 'selected';
																										} ?>>Other ethnic group</option>
																			</select>
																	...
																	<div class="row">
																		...
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			...
																			<select name="bodyType" class="form-control bodyType">
																				<option value="">select an option</option>
																				<option value="Skinny" <?php if ($row->bodyType == 'Skinny') {
																											echo 'selected';
																										} ?>>Skinny</option>
																				<option value="Slim" <?php if ($row->bodyType == 'Slim') {
																											echo 'selected';
																										} ?>>Slim</option>
																				<option value="Normal" <?php if ($row->bodyType == 'Normal') {
																											echo 'selected';
																										} ?>>Normal</option>
																				<option value="Curvy" <?php if ($row->bodyType == 'Curvy') {
																											echo 'selected';
																										} ?>>Curvy</option>
																				<option value="Sporty" <?php if ($row->bodyType == 'Sporty') {
																											echo 'selected';
																										} ?>>Sporty</option>
																				<option value="Muscular" <?php if ($row->bodyType == 'Muscular') {
																												echo 'selected';
																											} ?>>Muscular</option>
																				<option value="Overweight" <?php if ($row->bodyType == 'Overweight') {
																												echo 'selected';
																											} ?>>Overweight</option>
																	...
																	<div class="row">
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			...
																			<select name="excericseAvgWeek" class="form-control">
																				<option value="">select an option</option>
																				<option value="0 - 1" <?php if ($row->excericseAvgWeek == '0 - 1') {
																											echo 'selected';
																										} ?>>0-1 hour</option>
																				<option value="1 – 1.5" <?php if ($row->excericseAvgWeek == '1 – 1.5') {
																											echo 'selected';
																										} ?>>1 – 1.5 hours</option>
																				<option value="1.5 - 2" <?php if ($row->excericseAvgWeek == '1.5 - 2') {
																											echo 'selected';
																										} ?>>1.5 - 2 hours</option>
																				<option value="2 – 2.5" <?php if ($row->excericseAvgWeek == '2 – 2.5') {
																											echo 'selected';
																										} ?>>2 – 2.5 hours</option>
																				<option value="2.5 – 3" <?php if ($row->excericseAvgWeek == '2.5 – 3') {
																											echo 'selected';
																										} ?>>2.5 – 3 hours</option>
																				<option value="3 – 3.5" <?php if ($row->excericseAvgWeek == '3 – 3.5') {
																											echo 'selected';
																										} ?>>3 – 3.5 hours</option>
																				<option value="3.5 – 4" <?php if ($row->excericseAvgWeek == '3.5 – 4') {
																											echo 'selected';
																										} ?>>3.5 – 4 hours</option>
																				<option value="4 – 4.5" <?php if ($row->excericseAvgWeek == '4 – 4.5') {
																											echo 'selected';
																										} ?>>4 – 4.5 hours</option>
																				<option value="4.5 +" <?php if ($row->excericseAvgWeek == '4.5 +') {
																											echo 'selected';
																										} ?>>4.5 + hours</option>
																			</select>
																		...
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			...
																			<select name="stepAvgDay" class="form-control">
																				<option value="">select an option</option>
																				<option value="0000-2999 " <?php if ($row->stepAvgDay == '0000-2999 ') {
																												echo 'selected';
																											} ?>>0-2999 </option>
																				<option value="3000-5999 " <?php if ($row->stepAvgDay == '3000-5999 ') {
																												echo 'selected';
																											} ?>>3000-5999 </option>
																				<option value="6000-7999 " <?php if ($row->stepAvgDay == '6000-7999 ') {
																												echo 'selected';
																											} ?>>6000-7999 </option>
																				<option value="8000-9999 " <?php if ($row->stepAvgDay == '8000-9999 ') {
																												echo 'selected';
																											} ?>>8000-9999 </option>
																				<option value="10000-12999 " <?php if ($row->stepAvgDay == '10000-12999 ') {
																													echo 'selected';
																												} ?>>10000-12999 </option>
																				<option value="13000-14999 " <?php if ($row->stepAvgDay == '13000-14999 ') {
																													echo 'selected';
																												} ?>>13000-14999</option>
																				<option value="15000-20000 " <?php if ($row->stepAvgDay == '15000-20000 ') {
																													echo 'selected';
																												} ?>>15000+</option>
																			</select>
																	...
																	<div class="row">
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			...
																			<div class="radio-group">
																				...
																				<div class="md-radio md-radio-inline">
																					<input class="trackHeart rc" id="exercise_Yes" value="Yes" type="radio" name="exercise">
																				...
																				<div class="md-radio md-radio-inline">
																					<input class="trackHeart rc" checked id="exercise_No" value="No" type="radio" name="exercise">
																			...
																			<div class="add_detail trackHeart_detail " id="exerciseDetail">
																		...
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			...
																			<div class="radio-group">
																				...
																				<div class="md-radio md-radio-inline">
																					<input class="trackHeart rc" id="steps_Yes" value="Yes" type="radio" name="step">
																				...
																				<div class="md-radio md-radio-inline">
																					<input class="trackHeart rc" checked id="steps_No" value="No" type="radio" name="step">
																			...
																			<div class="add_detail trackHeart_detail  " id="stepDetail">
																	...
																	<div class="row">
																		...
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			...
																			<select name="sleepPerNight" class="form-control bodyType">
																				...
																				<option value="">select an option</option>
																				<option value="2" <?php if ($row->sleepPerNight == '2') {
																										echo 'selected';
																									} ?>>Less than 3</option>
																				<option value="3" <?php if ($row->sleepPerNight == '3') {
																										echo 'selected';
																									} ?>>3</option>
																				<option value="4" <?php if ($row->sleepPerNight == '4') {
																										echo 'selected';
																									} ?>>4</option>
																				<option value="5" <?php if ($row->sleepPerNight == '5') {
																										echo 'selected';
																									} ?>>5</option>
																				<option value="6" <?php if ($row->sleepPerNight == '6') {
																										echo 'selected';
																									} ?>>6</option>
																				<option value="7" <?php if ($row->sleepPerNight == '7') {
																										echo 'selected';
																									} ?>>7</option>
																				<option value="8" <?php if ($row->sleepPerNight == '8') {
																										echo 'selected';
																									} ?>>8</option>
																				<option value="9" <?php if ($row->sleepPerNight == '9') {
																										echo 'selected';
																									} ?>>9</option>
																				<option value="10" <?php if ($row->sleepPerNight == '10') {
																										echo 'selected';
																									} ?>>10</option>
																				<option value="11" <?php if ($row->sleepPerNight == '11') {
																										echo 'selected';
																									} ?>>11</option>
																				<option value="12+" <?php if ($row->sleepPerNight == '12+') {
																										echo 'selected';
																									} ?>>12+</option>
																		...
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			...
																			<select name="per_day_smoking" class="form-control bodyType">
																				...
																				<option value="">select an option</option>
																				<option value="no smoker" <?php if ($row->smoker == 'no smoker') {
																												echo 'selected';
																											} ?>>No smoker</option>
																				<option value="ex smoker" <?php if ($row->smoker == 'ex smoker') {
																												echo 'selected';
																											} ?>>Ex smoker</option>
																				<option value="9" <?php if ($row->smoker == '9') {
																										echo 'selected';
																									} ?>>less than 10 </option>
																				<option value="11" <?php if ($row->smoker == '11') {
																										echo 'selected';
																									} ?>>More than 10</option>
																				<option value="21" <?php if ($row->smoker == '21') {
																										echo 'selected';
																									} ?>>More than 20</option>
																...
																<div class="form-group">
																	<div class="row">
																		...
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			...
																			<div class="radio-group">
																				<div class="md-radio md-radio-inline">
																					<input class="sleepTrack" id="sleepTrack_Yes" value="Yes" type="radio" name="sleepTrack">
																					<label for="sleepTrack_Yes">Yes</label>
																				</div>
																				<div class="md-radio md-radio-inline">
																					<input class="sleepTrack" id="sleepTrack_No" checked value="No" type="radio" name="sleepTrack">
																					<label for="sleepTrack_No">No</label>
																				</div>
																			</div>


																			<div class="add_detail trackHeart_detail " id="sleepDetail">
																		...
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			...
																			<div class="radio-group">
																				<div class="md-radio md-radio-inline">
																					<input class="sleepTrack" id="smoke_Yes" value="Yes" type="radio" name="smokeTrack">
																					<label for="smoke_Yes">Yes</label>
																				</div>
																				<div class="md-radio md-radio-inline">
																					<input class="sleepTrack" id="smoke_No" checked value="No" type="radio" name="smokeTrack">
																					<label for="smoke_No">No</label>
																				</div>
																			</div>


																			<div class="add_detail trackHeart_detail" id="smokeDetail">
																	...
																	<div class="row">
																		...
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			...
																			<select name="avg_water" class="form-control bodyType">
																				<option value="">select an option</option>
																				<option value="0.5" <?php if ($row->waterAvgDay == '0.5') {
																										echo 'selected';
																									} ?>>less than 1 </option>
																				<option value="1 – 1.2" <?php if ($row->waterAvgDay == '1 – 1.2') {
																											echo 'selected';
																										} ?>>1 – 1.2</option>
																				<option value="1.3 – 1.9" <?php if ($row->waterAvgDay == '1.3 – 1.9') {
																												echo 'selected';
																											} ?>>1.3 – 1.9</option>
																				<option value="2 – 2.4" <?php if ($row->waterAvgDay == '2 – 2.4') {
																											echo 'selected';
																										} ?>>2 – 2.4</option>
																				<option value="2.5 – 2.9" <?php if ($row->waterAvgDay == '2.5 – 2.9') {
																												echo 'selected';
																											} ?>>2.5 – 2.9</option>
																				<option value="3 – 3.5" <?php if ($row->waterAvgDay == '3 – 3.5') {
																											echo 'selected';
																										} ?>>3 – 3.5</option>
																				<option value="3.6+" <?php if ($row->waterAvgDay == '3.6+') {
																											echo 'selected';
																										} ?>>3.6+</option>
																			</select>
																		</div>
																		...
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			...
																			<select name="avg_alcohol" class="form-control bodyType">
																				<option value="">select an option</option>
																				<option value="0" <?php if ($row->alcoholUnits == '0') {
																										echo 'selected';
																									} ?>>0</option>
																				<option value="6" <?php if ($row->alcoholUnits == '6') {
																										echo 'selected';
																									} ?>>Less than 7</option>
																				<option value="8-12" <?php if ($row->alcoholUnits == '8-12') {
																											echo 'selected';
																										} ?>>8-12</option>
																				<option value="12-14" <?php if ($row->alcoholUnits == '12-14') {
																											echo 'selected';
																										} ?>>12-14</option>
																				<option value="15" <?php if ($row->alcoholUnits == '15') {
																										echo 'selected';
																									} ?>>15+</option>
																			</select>
																		</div>
																...
																<div class="form-group">
																	<div class="row">
																		...
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			...
																			<div class="radio-group">
																				<div class="md-radio md-radio-inline">
																					<input class="sleepTrack" id="water_Yes" value="Yes" type="radio" name="waterTrack">
																					<label for="water_Yes">Yes</label>
																				</div>
																				<div class="md-radio md-radio-inline">
																					<input class="sleepTrack" id="water_No" checked value="No" type="radio" name="waterTrack">
																					<label for="water_No">No</label>
																				</div>
																			</div>


																			<div class="add_detail trackHeart_detail " id="waterDetails">
																		...
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			...
																			<div class="radio-group">
																				<div class="md-radio md-radio-inline">
																					<input class="sleepTrack" id="alcohol_Yes" value="Yes" type="radio" name="alcoholTrack">
																					<label for="alcohol_Yes">Yes</label>
																				</div>
																				<div class="md-radio md-radio-inline">
																					<input class="sleepTrack" id="alcohol_No" checked value="No" type="radio" name="alcoholTrack">
																					<label for="alcohol_No">No</label>
																				</div>
																			</div>


																			<div class="add_detail trackHeart_detail" id="alcoholDetails">
																...
																<div class="form-group" style="margin-bottom:10px;">
																	<div class="row">
																		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
																			...
																			<div class="radio-group">
																				<div class="md-radio md-radio-inline">
																					<input class="alergies rc" id="alergies_Yes" value="Yes" type="radio" name="alergies">
																					<label for="alergies_Yes">Yes</label>
																				</div>
																				<div class="md-radio md-radio-inline">
																					<input class="alergies rc" checked id="alergies_No" value="No" type="radio" name="alergies">
																					<label for="alergies_No">No</label>
																				</div>


																			</div>
																			<div class="add_detail alergies_detail">
																		...
																		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
																			...
																			<div class="radio-group">
																				<div class="md-radio md-radio-inline">
																					<input class="alergies rc" id="diet_Yes" value="Yes" type="radio" name="diet">
																					<label for="diet_Yes">Yes</label>
																				</div>
																				<div class="md-radio md-radio-inline">
																					<input class="alergies rc" checked id="diet_No" value="No" type="radio" name="diet">
																					<label for="diet_No">No</label>
																				</div>
																			</div>
																			<div class="add_detail" id="follow_diet">
																			...
																			<div class="add_detail <?php if ($row->dietDetails == 'other') {
																										echo 'show';
																									} ?>" id="not_follow_diet">
																		...
																		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
																			...
																			<div class="radio-group">
																				<div class="md-radio md-radio-inline">
																					<input class="intolerances rc" id="intolerances_Yes" value="Yes" type="radio" name="intolerances">
																					<label for="intolerances_Yes">Yes</label>
																				</div>
																				<div class="md-radio md-radio-inline">
																					<input class="intolerances rc" checked id="intolerances_No" value="No" type="radio" name="intolerances">
																					<label for="intolerances_No">No</label>
																				</div>
																				<div class="md-radio md-radio-inline">
																					<input class="intolerances rc" id="unsure" value="unsure" type="radio" name="intolerances">
															...
															<div class="single-service m-bottom0">
																...
																<div class="form-group">
																	<div class="row">
																		...
																		<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
																			...
																			<input type="text" class="form-control date" name="cholesterolLastCheck" value="<?php if ($row->cholesterolLastCheck != '0000-00-00') {
																																								echo $row->cholesterolLastCheck;
																																							} ?>" />
																		</div>
																		<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
																			<label>Do you track this?</label>
																			<div class="radio-group">
																				<div class="md-radio md-radio-inline">
																					<input class="trackHeart rc" id="trackCholesterol_Yes" value="Yes" type="radio" name="trackCholesterol">
																					<label for="trackCholesterol_Yes">Yes</label>
																				</div>
																				<div class="md-radio md-radio-inline">
																					<input class="trackHeart rc" checked id="trackCholesterol_No" value="No" type="radio" name="trackCholesterol">
																					<label for="trackCholesterol_No">No</label>
																				</div>
																			</div>
																			<div class="add_detail trackCholesterol_detail " id="cholesterol_detail">
																...
																<div class="form-group">
																	<div class="row">
																		...
																		<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
																			...
																			<input type="text" class="form-control date" name="heartLastCheck" value="<?php if ($row->heartLastCheck != '0000-00-00') {
																																							echo $row->heartLastCheck;
																																						} ?>" />
																		</div>
																		<div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
																			<label>Do you track this?</label>
																			<div class="radio-group">
																				<div class="md-radio md-radio-inline">
																					<input class="trackHeart rc" id="trackHeart_Yes" value="Yes" type="radio" name="trackHeart">
																					<label for="trackHeart_Yes">Yes</label>
																				</div>
																				<div class="md-radio md-radio-inline">
																					<input class="trackHeart rc" checked id="trackHeart_No" value="No" type="radio" name="trackHeart">
																					<label for="trackHeart_No">No</label>
																				</div>
																			</div>
																			<div class="add_detail trackHeart_detail ">
																...
																<div class="form-group">
																	<div class="row">
																		...
																		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
																			<label>Date last measured</label>
																			<input type="text" class="form-control date" name="bloodPressureLastCheck" value="<?php if ($row->bloodPressureLastCheck != '0000-00-00') {
																																									echo $row->bloodPressureLastCheck;
																																								} ?>" />
																		</div>
																		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
																			<label>Do you track this?</label>
																			<div class="radio-group">
																				<div class="md-radio md-radio-inline">
																					<input class="trackBlookPressure rc" id="trackBlookPressure_Yes" value="Yes" type="radio" name="trackBlookPressure">
																					<label for="trackBlookPressure_Yes">Yes</label>
																				</div>
																				<div class="md-radio md-radio-inline">
																					<input class="trackBlookPressure rc" checked id="trackBlookPressure_No" value="No" type="radio" name="trackBlookPressure">
																					<label for="trackBlookPressure_No">No</label>
																				</div>
																			</div>
																			<div class="add_detail trackBlookPressure_detail ">
																...
																<div class="form-group" style="display:none">
																	<div class="row">
																		...
																		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
																			...
																			<div class="radio-group">
																				<div class="md-radio md-radio-inline">
																					<input class="chronicKidneyDisease" id="chronicKidneyDisease_Yes" value="Yes" type="radio" name="chronicKidneyDisease">
																					<label for="chronicKidneyDisease_Yes">Yes</label>
																				</div>
																				<div class="md-radio md-radio-inline">
																					<input class="chronicKidneyDisease" checked id="chronicKidneyDisease_No" value="No" type="radio" name="chronicKidneyDisease">
																		...
																		<div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
																			...
																			<div class="radio-group">
																				<div class="md-radio md-radio-inline">
																					<input class="bloodPressureTreatment" id="bloodPressureTreatment_Yes" value="Yes" type="radio" name="bloodPressureTreatment">
																					<label for="bloodPressureTreatment_Yes">Yes</label>
																				</div>
																				<div class="md-radio md-radio-inline">
																					<input class="bloodPressureTreatment" checked id="bloodPressureTreatment_No" value="No" type="radio" name="bloodPressureTreatment">
																		...
																		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																			<div class="add_detail medi_his_detail" style="display:block;margin:0px">
																				<ul>
																					...
																					<li>
																						<input type="checkbox" value="dementia" name="family_medical[]"> heart attack in a 1st degree relative < 60 </li> <li>
																	...
																	<div class="form-group">
																		<div class="row">
																			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																				...
																				<div class="radio-group">
																					<div class="md-radio md-radio-inline">
																						<input class="trackHeart rc" id="testicular_Yes" value="Yes" type="radio" name="testicular_cancer">
																						<label for="testicular_Yes">Yes</label>
																					</div>
																					<div class="md-radio md-radio-inline">
																						<input class="trackHeart rc" checked id="testicular_No" value="No" type="radio" name="testicular_cancer">
																						<label for="testicular_No">No</label>
																					</div>
																				</div>
																				<div class="add_detail trackHeart_detail <?php if ($row->testicular_cancer == 'Yes') {
																																echo 'show';
																															} ?> " id="testicular_lastcheck">
																					<label>Date last measured</label>
																					<input type="text" class="form-control date" name="testicular_lastcheck" value="<?php if ($row->testicular_lastcheck != '0000-00-00') {
																																										echo $row->testicular_lastcheck;
																																									} ?>" />
																				</div>
																			</div>
																			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																				...
																				<div class="radio-group">
																					<div class="md-radio md-radio-inline">
																						<input class="trackHeart rc" id="prostate_Yes" value="Yes" type="radio" name="prostateCancer">
																						<label for="prostate_Yes">Yes</label>
																					</div>
																					<div class="md-radio md-radio-inline">
																						<input class="trackHeart rc" checked id="prostate_No" value="No" type="radio" name="prostateCancer">
																						<label for="prostate_No">No</label>
																					</div>
																				</div>
																				<div class="add_detail trackHeart_detail <?php if ($row->prostateCancer == 'Yes') {
																																echo 'show';
																															} ?> " id="prostateCancerLastCheck">
																					<label>Date last measured</label>
																					<input type="text" class="form-control date" name="prostateCancerLastCheck" value="<?php if ($row->prostateCancerLastCheck != '0000-00-00') {
																																											echo $row->prostateCancerLastCheck;
																																										} ?>" />
																				</div>
																			</div>
																		...
																		<div class="row">
																			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																				...
																				<div class="radio-group" style="display:none">
																					<div class="md-radio md-radio-inline">
																						<input class="medical rc" checked id="medical_Yes" value="Yes" type="radio" name="medical">
																						<label for="medical_Yes">Yes</label>
																					</div>
																					<div class="md-radio md-radio-inline">
																						<input class="medical rc" id="medical_No" value="No" type="radio" name="medical">
																						<label for="medical_No">No</label>
																					</div>


																				</div>
																				<div class="add_detail medical_detail <?php if ($row->trackMedical == 'Yes') {
																															echo 'show';
																			...
																			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																				...
																				<div class="radio-group" style="display:none">
																					<div class="md-radio md-radio-inline">
																						<input class="medi_his rc" id="medi_his_Yes" value="Yes" type="radio" name="track_family_med">
																						<label for="medi_his_Yes">Yes</label>
																					</div>
																					<div class="md-radio md-radio-inline">
																						<input class="medi_his rc" checked id="medi_his_No" value="No" type="radio" name="track_family_med">
																						<label for="medi_his_No">No</label>
																					</div>


																				</div>
																				<div class="add_detail medi_his_detail  <?php if ($row->track_family_med == 'Yes') {
																															echo 'show';
																														} ?>" id="medi_his_detail" style="display:block;margin:0px">
																	...
																	<div class="form-group">
																		<div class="row">
																			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
																				...
																				<div class="radio-group">
																					<div class="md-radio md-radio-inline">
																						<input class="trackHeart rc" id="ovarian_cancer_Yes" value="Yes" type="radio" name="ovarian_cancer">
																						<label for="ovarian_cancer_Yes">Yes</label>
																					</div>
																					<div class="md-radio md-radio-inline">
																						<input class="trackHeart rc" checked id="ovarian_cancer_No" value="No" type="radio" name="ovarian_cancer">
																						<label for="ovarian_cancer_No">No</label>
																					</div>
																				</div>
																				<div class="add_detail trackHeart_detail <?php if ($row->ovarian_cancer == 'Yes') {
																																echo 'show';
																															} ?> " id="ovarian_lastcheck">
																					<label>Date last measured</label>
																					<input type="text" class="form-control date" name="ovarian_lastcheck" value="<?php if ($row->ovarian_lastcheck != '0000-00-00') {
																																										echo $row->ovarian_lastcheck;
																																									} ?>" />
																				</div>
																			</div>
