										...
										<div class="row">
											<div class="col-lg-3 row m-0 text-center">
												...
												<div class="col-lg-12 col-md-12 col-xs-6  body-info body-info-mr">
													...
													<?php $e_unit = 'hour';
													if (trim($row->excericseAvgWeek) != '0-1') $e_unit .= 's'; ?>
													<div class="b_ans"><?php if ($row->excericseAvgWeek != "") {
																			echo $row->excericseAvgWeek . ' ' . $e_unit . '/Week';
																		} else {
																			echo '---';
																		} ?></div>
												...
												<div class="col-lg-12 col-md-12 col-xs-6 body-info">
													...
													<label>Sleep</label>
													<div class="b_ans"><?php if ($row->sleepPerNight > 0) {
																			if ($row->sleepPerNight == 2) echo 'Less than 3 Hours';
																			else if ($row->sleepPerNight == 12) echo '12+ Hours';
																			else echo intval($row->sleepPerNight) . ' Hours';
																		} else {
																			echo '---';
																		} ?></div>
												...
												<div class="col-lg-12 col-md-12 col-xs-6 body-info  body-info-mr">
													...
													<label>Steps</label>
													<div class="b_ans"><?php if ($row->stepAvgDay != "") {
																			if (trim($row->stepAvgDay) == '15000-20000') echo '15000+';
																			else echo $row->stepAvgDay . '/Day';
																		} else {
																			echo '---';
																		} ?></div>
												...
												<div class="col-lg-12 col-md-12 col-xs-6 body-info">
													...
													<label>Water</label>
													<div class="b_ans"><?php if ($row->waterAvgDay != "" && $row->waterAvgDay != 0) {
																			echo $row->waterAvgDay . ' liters/Day';
																		} else {
																			echo '---';
																		} ?></div>
											...
											<div class="col-lg-6 text-center">
												...
												<div class="human-body <?php if ($row->gender == 'Male') echo 'human-body-male';
																		else echo 'human-body-female'; ?> ">


													<div class="age" <?php
																		if (age($row->dob) == 0 || age($row->dob) == '') {
																		?> style="border-color: Grey;" <?php
																									}
																										?>>
														<div>
													...
													<?php $ratiom = 0;
													if ($row->hipMeasurment > 0) {
														$ratiom = floatval($row->waistMeasurment / $row->hipMeasurment);
														$ratiom = number_format($ratiom, 2);
													};  // by default is green < 0.90 or 0.85 
													?>

													<?php if ($row->gender == 'Female') { ?>

														<div class="hip-waist <?php if ($ratiom >= 0.85 && $ratiom <= 1) echo 'amber-color';
																				if ($ratiom > 1) echo 'red-color';
																				if ($ratiom > 0 && $ratiom <= 0.84) echo 'green-color';
																				else echo 'gray-color';  ?>">
															<div>

															<?php } else { ?>

																<div class="hip-waist <?php if ($ratiom >= 0.9 && $ratiom <= 1) echo 'amber-color';
																						if ($ratiom > 1) echo 'red-color';
																						if ($ratiom > 0 && $ratiom <= 0.89) echo 'green-color';
																						else echo 'gray-color';  ?>">
																	<div>
																...
																<div class="QRISK gray-color">
																	<div>
																		...
																		QRISK
																		<span style="color: #a19c9b"><?php if ($row->qriskk != '' || $row->qriskk == 0.00) echo $row->qriskk . ' %';
																										else echo '---'; ?></span>
																	</div>
																</div>
																<!--QRISK-->

																<div class="Weight" <?php
																...
																<div class="BMI <?php if ($row->weight >= 0 && $row->height >= 0) {
																					if ($bmi > 0 && $bmi <= 18.4) {
																						echo 'green-color';
																					} elseif ($bmi > 24.9) {
																						echo 'red-color';
																...
																<div class="Heart-Age gray-color">
																	<div>
																		...
																		Heart Age
																		<span style="color: #a19c9b"><?php if ($row->heart_age != '') echo $row->heart_age;
																										else echo '---'; ?></span>
																	</div>
																</div>
																<!--Heart Age-->
														...
														<div class="col-lg-3 row m-0 text-center">
															...
															if ($row->restHeartRate > 0 && $row->restHeartRate < 60) {  // 60-100 BPM 
																$hrt_img = base_url() . 'assets/front/images/icons/Heartrate-icon-Red.png';
															}

															if ($row->restHeartRate > 100) {
																$hrt_img = base_url() . 'assets/front/images/icons/Heartrate-icon-Red.png';
															}
															...
															<div class="col-lg-12 col-md-12 col-xs-6 body-info body-info-mr">
																...
																<div class="b_ans"><?php if ($row->restHeartRate > 0) {
																						echo number_format($row->restHeartRate) . ' bpm';
																					} else {
																						echo '---';
																					} ?></div>
															...
															<div class="col-lg-12 col-md-12 col-xs-6 body-info">
																...
																<div class="b_ans"><?php if ($row->bloodPressure > 0) {
																						echo number_format($row->systolic_bp) . '/' . number_format($row->bloodPressure) . ' mmHg';
																					} else {
																						echo '---';
																					} ?></div>
															...
															<div class="col-lg-12 col-md-12 col-xs-6 body-info body-info-mr">
																...
																<div class="b_ans"><?php if ($row->cholesterol > 0) {
																						echo number_format($row->cholesterol) . ' ratio';
																					} else {
																						echo '---';
																					} ?></div>
											...
											<div>
												...
												<?php $pname = $row->f_name;
												if (empty($row->f_name)) $pname = 'enc'; ?>
												...
												<?php foreach ($blogs as $blog) { ?>
													<div class="col-lg-4 col-md-4 col-xs-6 home-blog">
														<div class="single-blog">
															<a href="<?= base_url('blog/view/' . $blog->blogSlug) ?>" class="tran3s">
																<div class="image"><img src="<?= base_url('uploads/blog/' . $blog->blogImage) ?>" alt=""></div>
															</a>
