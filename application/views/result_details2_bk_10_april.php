							...
							<div class="col-lg-12 col-xs-12">
								...
								<div class="single-product shop-sidebar">
									...
									<div class="product-header">
										<h6 class="print-design"><img src="<?=base_url(); ?>uploads/tests/logo/<?php echo $order_details->testLogo; ?>" alt=""/>
												...
												foreach ($result_track_graph as $r)
												{
													foreach ($result_analytics as $key=>$row)
													{
														...
														if(date('Y-m',strtotime($row['y']))==date('Y-m',strtotime($r->createdAt)))
														{
															...
															// foreach($mrkrs as $mm){
															// 	//$result_analytics[$key]['x'.$p]=$mm->resultValue;
															// 	unset($result_analytics[$key]['x'.$p]);
															// 	$p++;
															// }
...
//echo '<pre>'; print_r($daily_analytics);
												...
												?>
													...
													<?php if(count($previous_results) > 1){ ?>
														...
														<select id="m_report" class="form-control" style="width: 20%; margin: 10px; margin-left: 80%;" onchange="get_report(this.value, '<?php echo $order_details->testId; ?>')">
												...
												<?php if(count($previous_results) > 1){ ?>
														...
														<div><h4 style="text-align: center; color: green; font-size: inherit;">Only one result available</h4></div>
														<?php } ?>
...
// if($results[0]->no_of_markers == 2){
// 	$ykeys = "['x', 'x1']";
// }else if($results[0]->no_of_markers == 3){
// 	$ykeys = ['x', 'x1', 'x2'];
// }else if($results[0]->no_of_markers == 4){
// 	$ykeys = ['x', 'x1', 'x2', 'x3'];
// }else if($results[0]->no_of_markers == 5){
// 	$ykeys = ['x', 'x1', 'x2', 'x3', 'x4'];
// }else if($results[0]->no_of_markers == 6){
// 	$ykeys = ['x', 'x1', 'x2', 'x3', 'x4', 'x5'];
// }
		...
		$.ajax({
			...
			if(marker_title == ""){
				Morris.Line({
					...
					<?php if($results[0]->no_of_markers == 2){ ?>
						ykeys : ['x', 'x1'],
						labels: ['Result Vlaue', 'Result Value'] ,
					<?php }else if($results[0]->no_of_markers == 3){ ?>
						ykeys : ['x', 'x1', 'x2'],
						labels: ['Result Vlaue', 'Result Value', 'Result Value'],
					<?php }else if($results[0]->no_of_markers == 4){ ?>
						ykeys : ['x', 'x1', 'x2', 'x3'],
						labels: ['Result Vlaue', 'Result Value', 'Result Value'], 'Result Value'],
					<?php }else if($results[0]->no_of_markers == 5){ ?>
						ykeys : ['x', 'x1', 'x2', 'x3', 'x4'],
						labels: ['Result Vlaue', 'Result Value', 'Result Value'], 'Result Value', 'Result Value'],
					<?php }else if($results[0]->no_of_markers == 6){ ?>
						ykeys : ['x', 'x1', 'x2', 'x3', 'x4', 'x5'],
						labels: ['Result Vlaue', 'Result Value', 'Result Value', 'Result Vlaue', 'Result Value', 'Result Value'],
					<?php }else if($results[0]->no_of_markers == 7){ ?>
						ykeys : ['x', 'x1', 'x2', 'x3', 'x4', 'x5', 'x6'],
						labels: ['Result Vlaue', 'Result Value', 'Result Value', 'Result Vlaue', 'Result Value', 'Result Value', 'Result Value'],
					<?php }else if($results[0]->no_of_markers == 8){ ?>
						ykeys : ['x', 'x1', 'x2', 'x3', 'x4', 'x5', 'x6', 'x7'],
						labels: ['Result Vlaue', 'Result Value', 'Result Value', 'Result Vlaue', 'Result Value', 'Result Value', 'Result Vlaue', 'Result Value'],
					<?php }else{ ?>
						ykeys : ['x'],
						labels: ['Result Vlaue'] ,
					<?php } ?>
...
<?php
    ...
    //echo 'vvvvvvvv'; echo '<pre>'; print_r($result_analytics1); //if($order_details->resultHistory=='Yes'){ ?>
		...
		Morris.Line({
			...
			data:[
				<?php
				foreach($result_analytics1 as $month) {
					echo json_encode($month).',';
				}?>],
			xkey: 'y',
