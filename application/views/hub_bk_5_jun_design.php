								...
								<div class="product-list">
									...
									<div class="row">
										<div class="col-lg-3 text-center">
											...
											<div class="body-info">
												<img class="m-auto" src="<?php echo base_url(); ?>assets/front/images/icons/Exercise-icon-amber.png">
											...
											<div class="body-info">
													<img class="m-auto" src="<?php echo base_url(); ?>assets/front/images/icons/Sleep-icon-amber.png">
												<label>Sleep</label>
											...
											<div class="body-info">
												<img class="m-auto" src="<?php echo base_url(); ?>assets/front/images/icons/Step-icon-Amber.png">
												<label>Steps</label>
											...
											<div class="body-info">
													<img class="m-auto" src="<?php echo base_url(); ?>assets/front/images/icons/water-icon-amber.png"> 
												<label>Water</label>
										...
										<div class="col-lg-3 text-center">
											...
											<div class="body-info">
													<img class="m-auto" src="<?php echo base_url(); ?>assets/front/images/icons/Heartrate-icon-Amber.png">
											...
											<div class="body-info">
												<img class="m-auto" src="<?php echo base_url(); ?>assets/front/images/icons/bloodpressure-icon-Amber.png">
											...
											<div class="body-info">
											<img class="m-auto" src="<?php echo base_url(); ?>assets/front/images/icons/cholesterol-icon -amber.png">
